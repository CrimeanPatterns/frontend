 ...
 * @group frontend-unit
 */
class LegacyMatcherTest extends AbstractClustererTest
{
    private ?LegacyMatcher $matcher;

    public function _before()
    {
        parent::_before();

        $this->matcher = $this->container->get(LegacyMatcher::class);
    }
    ...
    public function testCalculateSimilarity(bool $expectedMatch, LoungeInterface $lounge1, LoungeInterface $lounge2)
    {
        ...
        $threshold = LegacyMatcher::getThreshold();

 ...
 * @group frontend-unit
 */
class BusConverterTest extends AbstractSegmentConverterTest
{
    public function testValidateSchema()
    {
        $this->expectExceptionMessage(sprintf('Expected "%s", got "%s"', SchemaBus::class, SchemaEvent::class));
    ...
    public function testConvertSegment(bool $update)
    {
        ...
        $this->assertEquals('new bus', $entitySegment->getAircraftName());
    ...
    protected function getConverter(
        ...
        return new BusConverter(
            ...
            $this->getHelper($geo),
            $this->container->get(BusRideSegmentMatcher::class),
    ...
    /**
     * @return SchemaItinerary|SchemaBus
     */
        ...
        return SchemaBuilder::makeSchemaBus(
            [
                SchemaBuilder::makeSchemaBusSegment(
                    ...
                    'new number',
                    SchemaBuilder::makeSchemaVehicle(null, 'new bus'),

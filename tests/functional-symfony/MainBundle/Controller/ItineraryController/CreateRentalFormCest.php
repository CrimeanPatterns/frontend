 ...
 */
class CreateRentalFormCest extends CreateItineraryFormCest
{
    ...
    public function addToSelf(\TestSymfonyGuy $I)
    {
        ...
        $I->assertSame(Rental::TYPE_RENTAL, $rental->getType());
    }
    ...
    public function checkErrors(\TestSymfonyGuy $I)
    {
        ...
        $I->submitForm('form', [
            "rental[confirmationNumber]" => $I->grabRandomString(101),
            "rental[rentalCompany]" => $I->grabRandomString(81),
            "rental[pickUpAddress]" => $I->grabRandomString(161),
            "rental[pickUpDate][date]" => "INVALID_DATE",
            "rental[pickUpDate][time]" => "INVALID_TIME",
            "rental[dropOffAddress]" => $I->grabRandomString(161),
            "rental[dropOffDate][date]" => "INVALID_DATE",
            "rental[dropOffDate][time]" => "INVALID_TIME",
            "rental[phone]" => $I->grabRandomString(21),
            "rental[notes]" => $I->grabRandomString(4001),
        ]);
        ...
        $I->see('This value is too long. It should have 80 characters or less.', '#row-rentalCompany');
    ...
    protected function doSubmitForm(\TestSymfonyGuy $I, string $recordLocator)
    {
        $I->submitForm('form', [
            ...
            "rental[pickUpAddress]" => "Empire State Building",
            "rental[pickUpDate][date]" => "2017-01-01",
            "rental[pickUpDate][time]" => "16:00",
            "rental[dropOffAddress]" => "Statue of Liberty",

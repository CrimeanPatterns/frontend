 ...
 * @group moscow
 */
class CreateCruiseFormCest extends CreateItineraryFormCest
{
    ...
    public function addToSelf(\TestSymfonyGuy $I)
    {
        ...
        $I->assertEquals(TRIP::CATEGORY_CRUISE, $trip->getCategory());
        ...
        $I->assertEquals("TEST_SHIP", $tripsegment->getAirlineName());
    ...
    public function checkErrors(\TestSymfonyGuy $I)
    {
        ...
        $I->submitForm('form', [
            "cruise[owner]" => "",
            "cruise[confirmationNumber]" => $I->grabRandomString(101),
            "cruise[notes]" => $I->grabRandomString(4001),
        ]);
        ...
        $I->submitForm('form', [
            ...
            "cruise[segments][0][cruiseShop]" => $I->grabRandomString(251),
            "cruise[segments][0][route]" => $I->grabRandomString(21),
            "cruise[segments][0][departurePort]" => $I->grabRandomString(251),
            "cruise[segments][0][departureDate][date]" => "rubbish",
            "cruise[segments][0][departureDate][time]" => "rubbish",
            "cruise[segments][0][arrivalPort]" => $I->grabRandomString(251),
            "cruise[segments][0][arrivalDate][date]" => "rubbish",
            "cruise[segments][0][arrivalDate][time]" => "rubbish",

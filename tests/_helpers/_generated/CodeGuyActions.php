<?php  //[STAMP] 7f699c281d7abadd32cd5b2d0cf325d3
...
trait CodeGuyActions
{
     ...
     *
     *
     * @see \Codeception\Module\Clickhouse::copyToClickhouse()
     */
    public function copyToClickhouse(string $table, string $where) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('copyToClickhouse', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\Doctrine2Extras::assertNoQueries()
     */
    public function assertNoQueries(\Doctrine\DBAL\Connection $connection, callable $worker) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('assertNoQueries', func_get_args()));
    }
     ...
     *
     *
     * @see \Codeception\Module\Doctrine2Extras::assertQueriesCount()
     */
    public function assertQueriesCount($count, \Doctrine\DBAL\Connection $connection, callable $worker) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('assertQueriesCount', func_get_args()));
    }
     ...
     *
     * @return string mixed
     * @see \Codeception\Module\SymfonyExtras::getServiceClass()
     */
    public function getServiceClass($service) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getServiceClass', func_get_args()));
    }

...
var Translator = (function(document, undefined) {
    ...
    var DEBUG = isStorageSupported('localStorage') ? localStorage.getItem('DEBUG_TRANSLATION') == String(true) : false;
    ...
    function get_current_locale() {
        var zh = ['zh-TW', 'zh-CN'];
        return zh.indexOf(navigator.language) > -1 ? navigator.language.replace('-', '_') : navigator.language.split('-')[0];
    }
    ...
    return {
        ...
        trans: function(id, parameters, domain, locale) {
            ...
            if(DEBUG) {
                var domain = domain||'messages', trans = $.trim(replace_placeholders(_message, parameters || {}));
                app = app || {};
                app.translations = app.translations || {};
                app.translations[trans] = {key:id, value: trans, domain: domain, url: document.location.hash, parameters: parameters};
            }
        ...
        transChoice: function(id, number, parameters, domain, locale) {
            ...
            if(DEBUG) {
                ...
                app = app || {};
                app.translations = app.translations || {};
                app.translations[trans] = {key:id, value: trans, domain: domain, url: document.location.hash, parameters: parameters, number: number};
            }

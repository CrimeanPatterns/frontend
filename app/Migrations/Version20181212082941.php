 ...
 */
final class Version20181212082941 extends AbstractMigration
{
    ...
    public const MIGRATE_UPDATES_SINCE = '2019-01-15';
    public const MIGRATION_DATE = '2019-01-15';
    ...
    {
        $this->addSql("UPDATE Reservation SET Rooms = 'a:0:{}' WHERE Rooms IS NULL AND UpdateDate >= '" . self::MIGRATE_UPDATES_SINCE . "'");
        $this->addSql("UPDATE Rental SET RentalCompanyName = ProviderName WHERE UpdateDate >= '" . self::MIGRATE_UPDATES_SINCE . "'");

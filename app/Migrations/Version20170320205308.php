 ...
 */
class Version20170320205308 extends AbstractMigration
{
    public function up(Schema $schema): void
    {
        $this->addSql("
            create table `UserTripTargeting` (
                ...
                key `idx_UserTripTargeting_UserID_DestinationAirport` (`UserID`, `DestinationAirport`),
    ...
    {
        $this->addSql('DROP TABLE `UserTripTargeting`');
    }
}

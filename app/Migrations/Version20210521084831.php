 ...
 */
final class Version20210521084831 extends AbstractMigration implements ContainerAwareMigrationInterface
{
    use AirHelpImporterAwareTrait;

    public function getDescription(): string
    {
        return 'import awardwallet-brazil-first_reminder-20210520.csv to db';
    }

    public function up(Schema $schema): void
    {
        $this->airHelpImporter->saveCsvToDbFromMigration(
            [new CsvSource('awardwallet-brazil-first_reminder-20210520.csv', 'br_05_20')],
            $this
        );

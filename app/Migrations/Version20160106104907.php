 ...
 */
class Version20160106104907 extends AbstractMigration
{
    protected $replace = [
        ['new_booking_request_to_booker', 'new_booking_request'],
        ['new_booking_request_to_user', 'new_booking_request'],
        ['booking_change_status_booker', 'booking_change_status'],
    ];

 ...
 * @DateSequence()
 */
class TaxiModel extends AbstractModel implements DateSequenceInterface
{
    /**
     * @Assert\NotBlank()
     * @Assert\Length(max=80, maxMessage="max-length")
     */
    protected ?string $taxiCompany = null;
    ...
    public function getTaxiCompany(): ?string
    {
        return $this->taxiCompany;
    }

    public function setTaxiCompany(?string $taxiCompany): self
    {

...
class CruiseSegmentType extends AbstractSegmentItineraryType
{
    ...
    {
        $builder
            ->add('cruiseShip', TextType::class, [
                'label' => 'itineraries.trip.cruise.airline-name',
            ])
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => CruiseSegmentModel::class,

...
class RentalType extends AbstractItineraryType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('rentalCompany', GooglePlacesAutocompleteType::class, [
                'label' => 'itineraries.rental.rental-company',
            ])

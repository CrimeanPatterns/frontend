...
class TrainSegmentMatcher extends AbstractSegmentMatcher
{
    /**
    ...
    {
        if (!$schemaSegment instanceof SchemaTrainSegment) {
            throw new \InvalidArgumentException(sprintf('Expected %s, got %s', SchemaTrainSegment::class, get_class($schemaSegment)));
        }

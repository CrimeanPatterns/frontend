...
class ChaseSapphireLoungeLocationsAndAccess implements CategoryInterface, ReviewInterface
{
    public function match(LoungeInterface $lounge): bool
    {
        return preg_match('/\bChase\s+Sapphire\s+Lounge\b/i', $lounge->getName());
    }

...
/**
 * AdminScannerApi Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class AdminScannerApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @param  object $errorsOnly errorsOnly (optional)
     * @return object[]
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function listMailboxes($tags = null, $errorsOnly = null)
    {
        [$response] = $this->listMailboxesWithHttpInfo($tags, $errorsOnly);
     ...
     * @param  object $errorsOnly (optional)
     * @return array of object[], HTTP status code, HTTP response headers (array of strings)
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function listMailboxesWithHttpInfo($tags = null, $errorsOnly = null)
    {
        $returnType = 'object[]';
        $request = $this->listMailboxesRequest($tags, $errorsOnly);
     ...
     * @throws \InvalidArgumentException
     */
    public function listMailboxesAsync($tags = null, $errorsOnly = null)
    {
        return $this->listMailboxesAsyncWithHttpInfo($tags, $errorsOnly)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     */
    public function listMailboxesAsyncWithHttpInfo($tags = null, $errorsOnly = null)
    {
        $returnType = 'object[]';
        $request = $this->listMailboxesRequest($tags, $errorsOnly);
    ...
    /**
     * Operation resetMailbox.
     *
     * @param  object $mailboxId mailboxId (required)
     * @return void
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function resetMailbox($mailboxId)
    {
        $this->resetMailboxWithHttpInfo($mailboxId);
    }

    /**
     * Operation resetMailboxWithHttpInfo.
     *
     * @param  object $mailboxId (required)
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function resetMailboxWithHttpInfo($mailboxId)
    {
        $returnType = '';
        $request = $this->resetMailboxRequest($mailboxId);
    ...
    /**
     * Operation resetMailboxAsync.
     *
     * @param  object $mailboxId (required)
     * @return \GuzzleHttp\Promise\PromiseInterface
     * @throws \InvalidArgumentException
     */
    public function resetMailboxAsync($mailboxId)
    {
        return $this->resetMailboxAsyncWithHttpInfo($mailboxId)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation resetMailboxAsyncWithHttpInfo.
     *
     * @param  object $mailboxId (required)
     * @return \GuzzleHttp\Promise\PromiseInterface
     * @throws \InvalidArgumentException
     */
    public function resetMailboxAsyncWithHttpInfo($mailboxId)
    {
        $returnType = '';
        $request = $this->resetMailboxRequest($mailboxId);
     ...
     * @throws \InvalidArgumentException
     */
    protected function listMailboxesRequest($tags = null, $errorsOnly = null)
    {
        if ($tags !== null && strlen($tags) > 30) {
            throw new \InvalidArgumentException('invalid length for "$tags" when calling AdminScannerApi.listMailboxes, must be smaller than or equal to 30.');
        }

        $resourcePath = '/admin/scanner/mailboxes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($errorsOnly !== null) {
            $queryParams['errorsOnly'] = ObjectSerializer::toQueryValue($errorsOnly);
        }
    ...
    /**
     * Create request for operation 'resetMailbox'.
     *
     * @param  object $mailboxId (required)
     * @return \GuzzleHttp\Psr7\Request
     * @throws \InvalidArgumentException
     */
    protected function resetMailboxRequest($mailboxId)
    {
        // verify the required parameter 'mailboxId' is set
        if ($mailboxId === null || (is_array($mailboxId) && count($mailboxId) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $mailboxId when calling resetMailbox');
        }

        $resourcePath = '/admin/scanner/mailboxes/{mailboxId}/reset';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

...
/**
 * EmailParsingApi Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class EmailParsingApi
{
    /**
     * @var ClientInterface
     */
     ...
     *
     * @param  string $requestId You need to get the requestId from the [&#x60;/parseEmail&#x60;](#method-email_Parsing_1) method (required)
     * @return \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponse
    ...
    {
        [$response] = $this->checkWithHttpInfo($requestId);
     ...
     *
     * @param  string $requestId You need to get the requestId from the [&#x60;/parseEmail&#x60;](#method-email_Parsing_1) method (required)
     * @return array of \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function checkWithHttpInfo($requestId)
    {
        $returnType = '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponse';
        $request = $this->checkRequest($requestId);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponse',
     ...
     * @throws \InvalidArgumentException
     */
    public function checkAsync($requestId)
    {
        return $this->checkAsyncWithHttpInfo($requestId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \InvalidArgumentException
     */
    public function checkAsyncWithHttpInfo($requestId)
    {
        $returnType = '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponse';
        $request = $this->checkRequest($requestId);
     ...
     *
     * @param  \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailRequest $request request (required)
     * @return \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponseQueued
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function parse($request)
    {
        [$response] = $this->parseWithHttpInfo($request);
     ...
     * Submit Email for Parsing
     *
     * @param  \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailRequest $request (required)
     * @return array of \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponseQueued, HTTP status code, HTTP response headers (array of strings)
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function parseWithHttpInfo($request)
    {
        $returnType = '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponseQueued';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponseQueued',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     * @throws \InvalidArgumentException
     */
    public function parseAsync($request)
    {
     ...
     * @throws \InvalidArgumentException
     */
    public function parseAsyncWithHttpInfo($request)
    {
        $returnType = '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParseEmailResponseQueued';
        $request = $this->parseRequest($request);
    ...
    /**
     * Operation providersList.
     *
     * List providers
     *
     * @return \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ListProvidersResponse
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function providersList()
    {
        [$response] = $this->providersListWithHttpInfo();

        return $response;
    }

    /**
     * Operation providersListWithHttpInfo.
     *
     * List providers
     *
     * @return array of \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ListProvidersResponse, HTTP status code, HTTP response headers (array of strings)
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function providersListWithHttpInfo()
    {
        $returnType = '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ListProvidersResponse';
        $request = $this->providersListRequest();
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ListProvidersResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
     ...
     * @throws \InvalidArgumentException
     */
    public function providersListAsync()
    {
        return $this->providersListAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation providersListAsyncWithHttpInfo.
     *
     * List providers
     *
     * @return \GuzzleHttp\Promise\PromiseInterface
     * @throws \InvalidArgumentException
     */
    public function providersListAsyncWithHttpInfo()
    {
        $returnType = '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ListProvidersResponse';
        $request = $this->providersListRequest();
     ...
     * @throws \InvalidArgumentException
     */
    protected function checkRequest($requestId)
    {
        // verify the required parameter 'requestId' is set
        if ($requestId === null || (is_array($requestId) && count($requestId) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $requestId when calling check');
        }

        $resourcePath = '/json/v2/getResults/{requestId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function parseRequest($request)
    {
        ...
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling parse');
        }

        $resourcePath = '/json/v2/parseEmail';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Create request for operation 'providersList'.
     *
     * @return \GuzzleHttp\Psr7\Request
     * @throws \InvalidArgumentException
     */
    protected function providersListRequest()
    {
        $resourcePath = '/json/v2/providers/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

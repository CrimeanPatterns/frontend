...
class EmailScannerApi
{
    ...
    {
        [$response] = $this->connectAolMailboxWithHttpInfo($request);
    ...
    {
        [$response] = $this->connectGoogleMailboxWithHttpInfo($request);
    ...
    {
        [$response] = $this->connectImapMailboxWithHttpInfo($request);
    ...
    {
        [$response] = $this->connectMicrosoftMailboxWithHttpInfo($request);
    ...
    {
        [$response] = $this->connectYahooMailboxWithHttpInfo($request);
    ...
    {
        [$response] = $this->detectTypeWithHttpInfo($email);
    ...
    {
        [$response] = $this->getAuthCodeMailboxWithHttpInfo($request);
    ...
    {
        [$response] = $this->getMailboxWithHttpInfo($mailboxId);
    ...
    {
        [$response] = $this->listMailboxesWithHttpInfo($tags, $states, $types, $errorCodes);
    ...
    {
        [$response] = $this->putMailboxWithHttpInfo($mailboxId, $request);
    ...
    {
        [$response] = $this->scrollMailboxesWithHttpInfo($tags, $states, $types, $errorCodes, $pageToken);
    ...
    protected function authMailboxRequest($code)
    {
        ...
        if ($code === null || (is_array($code) && count($code) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $code when calling authMailbox');
        }
    ...
    protected function connectAolMailboxRequest($request)
    {
        ...
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling connectAolMailbox');
        }
    ...
    protected function connectGoogleMailboxRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling connectGoogleMailbox');
        }
    ...
    protected function connectImapMailboxRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling connectImapMailbox');
        }
    ...
    protected function connectMicrosoftMailboxRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling connectMicrosoftMailbox');
        }
    ...
    protected function connectYahooMailboxRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling connectYahooMailbox');
        }
    ...
    protected function detectTypeRequest($email)
    {
        ...
        if ($email === null || (is_array($email) && count($email) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $email when calling detectType');
        }
    ...
    protected function disconnectMailboxRequest($mailboxId, $revoke = null)
    {
        ...
        if ($mailboxId === null || (is_array($mailboxId) && count($mailboxId) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $mailboxId when calling disconnectMailbox');
        }
    ...
    protected function getAuthCodeMailboxRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling getAuthCodeMailbox');
        }
    ...
    protected function getMailboxRequest($mailboxId)
    {
        // verify the required parameter 'mailboxId' is set
        if ($mailboxId === null || (is_array($mailboxId) && count($mailboxId) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $mailboxId when calling getMailbox');
        }
    ...
    protected function putMailboxRequest($mailboxId, $request)
    {
        // verify the required parameter 'mailboxId' is set
        if ($mailboxId === null || (is_array($mailboxId) && count($mailboxId) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $mailboxId when calling putMailbox');
        }

        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling putMailbox');
        }

...
/**
 * AdminPartnerMailboxApi Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class AdminPartnerMailboxApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation addPartnerMailbox.
     *
     * @param  \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\AdminAddPartnerMailboxRequest $request request (required)
     * @return object[]
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function addPartnerMailbox($request)
    {
        [$response] = $this->addPartnerMailboxWithHttpInfo($request);

        return $response;
    }

    /**
     * Operation addPartnerMailboxWithHttpInfo.
     *
     * @param  \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\AdminAddPartnerMailboxRequest $request (required)
     * @return array of object[], HTTP status code, HTTP response headers (array of strings)
     * @throws \AwardWallet\MainBundle\Service\EmailParsing\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     */
    public function addPartnerMailboxWithHttpInfo($request)
    {
        $returnType = 'object[]';
        $request = $this->addPartnerMailboxRequest($request);
    ...
    /**
     * Operation addPartnerMailboxAsync.
     *
     * @param  \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\AdminAddPartnerMailboxRequest $request (required)
     * @return \GuzzleHttp\Promise\PromiseInterface
     * @throws \InvalidArgumentException
     */
    public function addPartnerMailboxAsync($request)
    {
        return $this->addPartnerMailboxAsyncWithHttpInfo($request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation addPartnerMailboxAsyncWithHttpInfo.
     *
     * @param  \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\AdminAddPartnerMailboxRequest $request (required)
     * @return \GuzzleHttp\Promise\PromiseInterface
     * @throws \InvalidArgumentException
     */
    public function addPartnerMailboxAsyncWithHttpInfo($request)
    {
        $returnType = 'object[]';
        $request = $this->addPartnerMailboxRequest($request);
    ...
    /**
     * Create request for operation 'addPartnerMailbox'.
     *
     * @param  \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\AdminAddPartnerMailboxRequest $request (required)
     * @return \GuzzleHttp\Psr7\Request
     * @throws \InvalidArgumentException
     */
    protected function addPartnerMailboxRequest($request)
    {
        // verify the required parameter 'request' is set
        if ($request === null || (is_array($request) && count($request) === 0)) {
            throw new \InvalidArgumentException('Missing the required parameter $request when calling addPartnerMailbox');
        }

        $resourcePath = '/admin/partner/mailboxes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

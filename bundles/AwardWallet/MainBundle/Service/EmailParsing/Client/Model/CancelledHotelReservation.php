...
/**
 * CancelledHotelReservation Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class CancelledHotelReservation implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'CancelledHotelReservation';
    ...
    public function setGuestCount($guestCount)
    {
        if (!is_null($guestCount) && ($guestCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $guestCount when calling CancelledHotelReservation., must be bigger than or equal to 1.');
        }
    ...
    public function setKidsCount($kidsCount)
    {
        if (!is_null($kidsCount) && ($kidsCount < 0)) {
            throw new \InvalidArgumentException('invalid value for $kidsCount when calling CancelledHotelReservation., must be bigger than or equal to 0.');
        }
    ...
    public function setRoomsCount($roomsCount)
    {
        if (!is_null($roomsCount) && ($roomsCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $roomsCount when calling CancelledHotelReservation., must be bigger than or equal to 1.');
        }

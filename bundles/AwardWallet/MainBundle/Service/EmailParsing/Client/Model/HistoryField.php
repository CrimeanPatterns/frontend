...
/**
 * HistoryField Class Doc Comment.
 *
 * @category Class
 ...
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class HistoryField implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'HistoryField';
     ...
     * Sets name.
     *
     * @param string $name User-friendly name of the field, i.e. “Posting Date” that you can show as the column heading to your end users.
     * @return $this
     */
     ...
     * Sets value.
     *
     * @param string $value The actual field value, such as \"10,000\"
     * @return $this
     */

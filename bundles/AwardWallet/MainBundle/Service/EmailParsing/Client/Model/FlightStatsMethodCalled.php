...
/**
 * FlightStatsMethodCalled Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class FlightStatsMethodCalled implements ModelInterface, \ArrayAccess
{
    public const DISCRIMINATOR = null;

    public const NAME_SCHEDULE_BY_FLIGHT = 'ScheduleByFlight';
    public const NAME_SCHEDULE_BY_ROUTE = 'ScheduleByRoute';
    public const NAME_SCHEDULE_BY_AIRPORT = 'ScheduleByAirport';
    public const NAME_HISTORICAL_BY_FLIGHT = 'HistoricalByFlight';
    public const NAME_HISTORICAL_BY_ROUTE = 'HistoricalByRoute';
    public const NAME_HISTORICAL_BY_AIRPORT = 'HistoricalByAirport';
     ...
     * @var string
     */
    protected static $swaggerModelName = 'FlightStatsMethodCalled';
    ...
    {
        return [
            self::NAME_SCHEDULE_BY_FLIGHT,
            self::NAME_SCHEDULE_BY_ROUTE,
            self::NAME_SCHEDULE_BY_AIRPORT,
            self::NAME_HISTORICAL_BY_FLIGHT,
            self::NAME_HISTORICAL_BY_ROUTE,
            self::NAME_HISTORICAL_BY_AIRPORT,
        ];
    }
     ...
     * Sets name.
     *
     * @param string $name The name of the FlightStats API method that was called during the parsing. Here are the possible values:  - ScheduleByFlight  - ScheduleByRoute  - ScheduleByAirport  - HistoricalByFlight  - HistoricalByRoute  - HistoricalByAirport
     * @return $this
     */
     ...
     * Sets count.
     *
     * @param int $count number of calls made to this method
     * @return $this
     */

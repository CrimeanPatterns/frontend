...
class Address implements ModelInterface, \ArrayAccess
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['stateName'] = $data['stateName'] ?? null;
     ...
     * Sets text.
     *
     * @param string $text Non-validated address string. You can usually use this line to search some API (i.e. Google API) to get detailed / structured information about that address. We usually just grab this text as-is from the provider’s website.
     * @return $this
     */
     ...
     * Sets addressLine.
     *
     * @param string $addressLine validated address line of the address (without the city, state, country and zip code) that we got from Google API
     * @return $this
     */
     ...
     * Sets city.
     *
     * @param string $city Name of the city validated by the Google API
     * @return $this
     */
     ...
     * Sets stateName.
     *
     * @param string $stateName Name of the state validated by the Google API
     * @return $this
     */
     ...
     * Sets countryName.
     *
     * @param string $countryName Name of the country validated by the Google API
     * @return $this
     */
     ...
     * Sets postalCode.
     *
     * @param string $postalCode Zip / postal code validated by the Google API
     * @return $this
     */
     ...
     * Sets lat.
     *
     * @param float $lat Latitude coordinate of the address
     * @return $this
     */
     ...
     * Sets lng.
     *
     * @param float $lng Longitude coordinate of the address
     * @return $this
     */
     ...
     * Sets timezone.
     *
     * @param int $timezone time zone in which this address is located
     * @return $this
     */
     ...
     * Sets timezoneId.
     *
     * @param string $timezoneId Name of the time zone
     * @return $this
     */

...
/**
 * VehicleExt Class Doc Comment.
 *
 * @category Class
 * @description This object describes a vehicle/trailer
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class VehicleExt implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'VehicleExt';
     ...
     * Sets model.
     *
     * @param string $model Model of the vehicle/trailer
     * @return $this
     */
     ...
     * Sets length.
     *
     * @param string $length Length of the vehicle/trailer (size description, includes number, e.g. \"Less than 6.00 metres\")
     * @return $this
     */
     ...
     * Sets height.
     *
     * @param string $height Height of the vehicle/trailer (size description, includes number, e.g. \"Less than 1.80 metres\")
     * @return $this
     */
     ...
     * Sets width.
     *
     * @param string $width Width of the vehicle/trailer (size description, includes number.)
     * @return $this
     */

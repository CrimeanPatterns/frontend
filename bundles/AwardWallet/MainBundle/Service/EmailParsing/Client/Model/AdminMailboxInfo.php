...
/**
 * AdminMailboxInfo Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class AdminMailboxInfo implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'AdminMailboxInfo';
    ...
    protected static $swaggerTypes = [
        'mailbox' => '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Mailbox',
        'partner' => 'string',
        'error' => 'string',
        'errorCount' => 'int',
        'state' => 'string',
     ...
     * Sets mailbox.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Mailbox $mailbox mailbox
     * @return $this
     */
     ...
     * @return string
     */
    public function getBackoffDate()
    {
        return $this->container['backoffDate'];
    }

    /**
     * Sets backoffDate.
     *
     * @param string $backoffDate backoffDate
     * @return $this
     */
    public function setBackoffDate($backoffDate)
    {
        $this->container['backoffDate'] = $backoffDate;

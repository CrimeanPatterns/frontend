...
/**
 * ParsedNumber Class Doc Comment.
 *
 * @category Class
 * @description This object represents a ticket or an account number.
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ParsedNumber implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ParsedNumber';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['masked'] === null) {
            $invalidProperties[] = "'masked' can't be null";
        }
     ...
     * Sets number.
     *
     * @param string $number Number as it was parsed from the email
     * @return $this
     */
     ...
     * Sets masked.
     *
     * @param bool $masked Will be set to `true` if the number is partially masked (i.e.\"XXXX1234\", \"****5678\").
     * @return $this
     */

 ...
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class PricingInfo implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'PricingInfo';
    ...
    protected static $swaggerTypes = [
        ...
        'spentAwards' => 'string',
        'currencyCode' => 'string',
        'fees' => '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Fee[]',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['spentAwards'] = $data['spentAwards'] ?? null;
     ...
     * Sets total.
     *
     * @param float $total total cost of the reservation including all taxes and fees
     * @return $this
     */
     ...
     * Sets cost.
     *
     * @param float $cost cost of the reservation before taxes
     * @return $this
     */
     ...
     * Sets discount.
     *
     * @param float $discount total amount of discounts, if any
     * @return $this
     */
    ...
    {
        return $this->container['spentAwards'];
    }

    /**
     * Sets spentAwards.
     *
     * @param string $spentAwards frequent flier miles, points, or other kinds or bonuses spent on this reservation
     * @return $this
     */
    public function setSpentAwards($spentAwards)
    {
        $this->container['spentAwards'] = $spentAwards;
     ...
     * Sets currencyCode.
     *
     * @param string $currencyCode Currency code as gathered from the website. I.e. `USD`.
     * @return $this
     */
     ...
     * Sets fees.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Fee[] $fees various fees associated with the reservation
     * @return $this
     */

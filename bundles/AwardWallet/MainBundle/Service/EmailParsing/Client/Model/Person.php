...
class Person implements ModelInterface, \ArrayAccess
{
     ...
     * Sets name.
     *
     * @param string $name name of the person listed on the reservation
     * @return $this
     */
     ...
     * Sets full.
     *
     * @param bool $full Sometimes passenger or guest names are shortened on the reservation, if we are able to detect it, this field will reflect that. It will be set to `true` if the we know the name is full (for example John J Smith) and `false` if the name is shortened, for example (John S.).
     * @return $this
     */

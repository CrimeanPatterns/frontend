<?php
/**
 * BaseUpdateableMailboxProperties.
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * BaseUpdateableMailboxProperties Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class BaseUpdateableMailboxProperties implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'BaseUpdateableMailboxProperties';
    ...
    public function setCallbackUrl($callbackUrl)
    {
        if (!is_null($callbackUrl) && (mb_strlen($callbackUrl) > 250)) {
            throw new \InvalidArgumentException('invalid length for $callbackUrl when calling BaseUpdateableMailboxProperties., must be smaller than or equal to 250.');
        }

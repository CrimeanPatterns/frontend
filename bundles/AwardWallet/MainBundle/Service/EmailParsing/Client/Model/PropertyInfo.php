...
class PropertyInfo implements ModelInterface, \ArrayAccess
{
     ...
     * Sets code.
     *
     * @param string $code Property code name. Can only have English numbers and letters with no spaces.
     * @return $this
     */
     ...
     * Sets name.
     *
     * @param string $name User friendly name of a property such as “Account number”. You can display this to your end users.
     * @return $this
     */

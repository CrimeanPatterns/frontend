<?php
/**
 * AdminAddPartnerMailboxResponse.
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AdminAddPartnerMailboxResponse Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class AdminAddPartnerMailboxResponse implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'AdminAddPartnerMailboxResponse';
    ...
    {
        $this->container['setupUrl'] = $data['setupUrl'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['setupUrl'] === null) {
            $invalidProperties[] = "'setupUrl' can't be null";
        }
    ...
    {
        return $this->container['setupUrl'];
    }

    /**
     * Sets setupUrl.
     *
     * @param string $setupUrl setupUrl
     * @return $this
     */
    public function setSetupUrl($setupUrl)
    {
        $this->container['setupUrl'] = $setupUrl;

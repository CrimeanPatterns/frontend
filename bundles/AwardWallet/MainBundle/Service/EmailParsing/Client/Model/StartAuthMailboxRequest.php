...
/**
 * StartAuthMailboxRequest Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class StartAuthMailboxRequest implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'StartAuthMailboxRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['redirectUrl']) && (mb_strlen($this->container['redirectUrl']) > 1024)) {
    ...
    public function setCallbackUrl($callbackUrl)
    {
        if (!is_null($callbackUrl) && (mb_strlen($callbackUrl) > 250)) {
            throw new \InvalidArgumentException('invalid length for $callbackUrl when calling StartAuthMailboxRequest., must be smaller than or equal to 250.');
        }
     ...
     * Sets provider.
     *
     * @param string $provider Mailbox provider, against which you wish to authenticate. Can be one of the values: `google`, `microsoft`, `yahoo`, `aol`.
     * @return $this
     */
    public function setProvider($provider)
    {
        ...
        if (!is_null($provider) && !in_array($provider, $allowedValues, true)) {
            throw new \InvalidArgumentException(sprintf("Invalid value for 'provider', must be one of '%s'", implode("', '", $allowedValues)));
        }
    ...
    {
        if (!is_null($redirectUrl) && (mb_strlen($redirectUrl) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $redirectUrl when calling StartAuthMailboxRequest., must be smaller than or equal to 1024.');
        }
     ...
     * Sets host.
     *
     * @param string $host Optional host name which you would set up on your end as a CNAME record pointing to service.awardwallet.com. You only need to do this if you wish to hide a redirect to service.awardwallet.com as part of your users' authentication process. You then need to add it as an \"Authorized Redirect URI\" under your OAuth 2.0 client ID.
     * @return $this
     */
    public function setHost($host)
    {
        if (!is_null($host) && (mb_strlen($host) > 80)) {
            throw new \InvalidArgumentException('invalid length for $host when calling StartAuthMailboxRequest., must be smaller than or equal to 80.');
        }

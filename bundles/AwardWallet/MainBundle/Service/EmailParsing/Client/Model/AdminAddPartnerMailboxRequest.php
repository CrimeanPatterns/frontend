...
/**
 * AdminAddPartnerMailboxRequest Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class AdminAddPartnerMailboxRequest implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'AdminAddPartnerMailboxRequest';
     ...
     * Sets type.
     *
     * @param string $type The type of the established connection. Could be one of values: `imap`, `google`, `microsoft`, `yahoo`.
     * @return $this
     */

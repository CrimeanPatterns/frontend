 ...
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ListProvidersResponse implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ListProvidersResponse';
     ...
     * Sets providers.
     *
     * @param object[] $providers an array of individual providers (that we support with our Email Parsing API) for which we can retrieve travel itineraries (and in some rare cases loyalty information) from emails
     * @return $this
     */

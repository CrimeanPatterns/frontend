...
/**
 * ListProvidersItem Class Doc Comment.
 *
 * @category Class
 * @description null
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ListProvidersItem implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ListProvidersItem';
    ...
    protected static $attributeMap = [
        ...
        'supportedFormatCount' => 'supportedFormatCount',
    ...
    protected static $setters = [
        ...
        'supportedFormatCount' => 'setSupportedFormatCount',
        'properties' => 'setProperties',
        'historyColumns' => 'setHistoryColumns',
    ];
    ...
    protected static $getters = [
        ...
        'supportedFormatCount' => 'getSupportedFormatCount',
        'properties' => 'getProperties',
        'historyColumns' => 'getHistoryColumns',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['supportedFormatCount'] = $data['supportedFormatCount'] ?? null;
        $this->container['properties'] = $data['properties'] ?? null;
        $this->container['historyColumns'] = $data['historyColumns'] ?? null;
    }
     ...
     * Sets code.
     *
     * @param string $code alpha-numeric value with no spaces that uniquely identifies any given provider
     * @return $this
     */
     ...
     * Sets displayName.
     *
     * @param string $displayName User friendly display name of the provider. Typically includes both the company name and the name of the loyalty program, i.e. Delta Air Lines (SkyMiles).
     * @return $this
     */
     ...
     * Sets shortName.
     *
     * @param string $shortName shortened display name of the provider
     * @return $this
     */
     ...
     *
     * @param string[] $supportedLanguages Array of ISO 639-1 2-letter language codes which are supported for email parsing for this provider
     * @return $this
     */
    ...
    /**
     * Gets supportedFormatCount.
     *
     * @return int
     */
    public function getSupportedFormatCount()
    {
        return $this->container['supportedFormatCount'];
    }

    /**
     * Sets supportedFormatCount.
     *
     * @param int $supportedFormatCount Estimated number of email formats supported for email parsing for this provider
     * @return $this
     */
    public function setSupportedFormatCount($supportedFormatCount)
    {
        $this->container['supportedFormatCount'] = $supportedFormatCount;
     ...
     * Sets properties.
     *
     * @param object[] $properties array of account properties (secondary attributes) that we may gather from email account statements
     * @return $this
     */
    ...
    {
        return $this->container['historyColumns'];
    }

    /**
     * Sets historyColumns.
     *
     * @param object[] $historyColumns array of account transaction history columns that we may gather from emails
     * @return $this
     */
    public function setHistoryColumns($historyColumns)
    {
        $this->container['historyColumns'] = $historyColumns;

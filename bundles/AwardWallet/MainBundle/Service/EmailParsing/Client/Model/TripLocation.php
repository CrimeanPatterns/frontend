 ...
 *
 * @category Class
 * @description This object is describing the arrival or departure events of air travel.
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class TripLocation implements ModelInterface, \ArrayAccess
{
     ...
     * Sets airportCode.
     *
     * @param string $airportCode if this location happened to be an airport this field will return a Validated IATA airport code
     * @return $this
     */
     ...
     * Sets terminal.
     *
     * @param string $terminal in cases when terminal is known it will be returned in this field
     * @return $this
     */
     ...
     * Sets name.
     *
     * @param string $name Train station name or airport name such as “John F. Kennedy International Airport”.
     * @return $this
     */

...
/**
 * MarketingCarrier Class Doc Comment.
 *
 * @category Class
 * @description The flight and airline information as it shows up on the ticket.
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class MarketingCarrier implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'MarketingCarrier';
    ...
    protected static $swaggerTypes = [
        'airline' => '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Airline',
        'flightNumber' => 'string',
        'confirmationNumber' => 'string',
        'phoneNumbers' => '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\PhoneNumber[]',
        'isCodeshare' => 'bool',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['confirmationNumber'] = $data['confirmationNumber'] ?? null;
        $this->container['phoneNumbers'] = $data['phoneNumbers'] ?? null;
        $this->container['isCodeshare'] = $data['isCodeshare'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['airline'] === null) {
            $invalidProperties[] = "'airline' can't be null";
        }
     ...
     * Sets airline.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Airline $airline object describing the airline that is listed on the ticket, sometimes it is the 2 letter prefix that goes before the flight number as listed on the issued ticket
     * @return $this
     */
     ...
     * Sets flightNumber.
     *
     * @param string $flightNumber flight number that is listed on the passenger’s ticket
     * @return $this
     */
    ...
    {
        return $this->container['confirmationNumber'];
    }

    /**
     * Sets confirmationNumber.
     *
     * @param string $confirmationNumber Passenger name record, a.k.a. PNR that is associated with the airline the passenger was ticketed for.
     * @return $this
     */
    public function setConfirmationNumber($confirmationNumber)
    {
        $this->container['confirmationNumber'] = $confirmationNumber;
     ...
     * Gets phoneNumbers.
     *
     * @return \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\PhoneNumber[]
     */
     ...
     * Sets phoneNumbers.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\PhoneNumber[] $phoneNumbers airline phone numbers as shown in the email or the number(s) could be populated by AwardWallet automatically based on the airline even if the numbers were not present in the email
     * @return $this
     */
    ...
    {
        return $this->container['isCodeshare'];
    }

    /**
     * Sets isCodeshare.
     *
     * @param bool $isCodeshare If this is a codeshare flight and we know the actual operating airline, we would set this attribute to `true` and then list the actual operating airline (only if it is different from the `marketingCarrier.airline`) in the `operatingCarrier` object.
     * @return $this
     */
    public function setIsCodeshare($isCodeshare)
    {
        $this->container['isCodeshare'] = $isCodeshare;

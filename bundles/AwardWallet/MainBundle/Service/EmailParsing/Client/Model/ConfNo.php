...
/**
 * ConfNo Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ConfNo implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ConfNo';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['isPrimary'] = $data['isPrimary'] ?? null;
    }
     ...
     * Sets number.
     *
     * @param string $number Confirmation number
     * @return $this
     */
     ...
     * Sets description.
     *
     * @param string $description Confirmation number description
     * @return $this
     */
     ...
     * Sets isPrimary.
     *
     * @param bool $isPrimary Indicates whether this confirmation number can be considered as primary
     * @return $this
     */

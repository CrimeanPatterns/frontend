...
/**
 * BaseConnectMailboxRequest Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class BaseConnectMailboxRequest implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'BaseConnectMailboxRequest';
    ...
    public function setCallbackUrl($callbackUrl)
    {
        if (!is_null($callbackUrl) && (mb_strlen($callbackUrl) > 250)) {
            throw new \InvalidArgumentException('invalid length for $callbackUrl when calling BaseConnectMailboxRequest., must be smaller than or equal to 250.');
        }

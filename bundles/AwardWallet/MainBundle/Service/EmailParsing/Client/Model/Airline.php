...
class Airline implements ModelInterface, \ArrayAccess
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['iata'] = $data['iata'] ?? null;
        $this->container['icao'] = $data['icao'] ?? null;
    }
     ...
     * Sets iata.
     *
     * @param string $iata IATA code of the airline
     * @return $this
     */
     ...
     * Sets icao.
     *
     * @param string $icao international Civil Aviation Organization airline code
     * @return $this
     */

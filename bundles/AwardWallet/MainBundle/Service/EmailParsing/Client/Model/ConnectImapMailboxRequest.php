...
/**
 * ConnectImapMailboxRequest Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ConnectImapMailboxRequest implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ConnectImapMailboxRequest';
    ...
    public function setCallbackUrl($callbackUrl)
    {
        if (!is_null($callbackUrl) && (mb_strlen($callbackUrl) > 250)) {
            throw new \InvalidArgumentException('invalid length for $callbackUrl when calling ConnectImapMailboxRequest., must be smaller than or equal to 250.');
        }
    ...
    public function setHost($host)
    {
        if (!is_null($host) && (mb_strlen($host) > 120)) {
            throw new \InvalidArgumentException('invalid length for $host when calling ConnectImapMailboxRequest., must be smaller than or equal to 120.');
        }
    ...
    public function setLogin($login)
    {
        if (!is_null($login) && (mb_strlen($login) > 120)) {
            throw new \InvalidArgumentException('invalid length for $login when calling ConnectImapMailboxRequest., must be smaller than or equal to 120.');
        }
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 250)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ConnectImapMailboxRequest., must be smaller than or equal to 250.');
        }

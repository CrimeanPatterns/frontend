 ...
 *
 * @category Class
 * @description In case if the email contains a loyalty account statement that we are able to parse, the individual loyalty account properties will be returned in this array.
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class Property implements ModelInterface, \ArrayAccess
{
     ...
     * Sets code.
     *
     * @param string $code this is a short, alphanumeric codename do describe this attribute
     * @return $this
     */
     ...
     * Sets name.
     *
     * @param string $name User friendly name of the property such as “Account number”. You can display this to your end users.
     * @return $this
     */
     ...
     * Sets kind.
     *
     * @param string $kind Type of property, the possible values are:  **0** - Basic property  **1** - Account number  **3** - Elite Status  **4** - Lifetime points  **7** - Points / miles earned year-to-date (YTD).  **8** - Segments earned year-to-date (YTD).  **12** - Name of the account holder, as listed on the account.  **13** - Date of the last account activity.  **101** - Login information  **102** - Partial login information if it was masked in the email  **103** - Partial account number if it was masked in the email
     * @return $this
     */
     ...
     * Sets value.
     *
     * @param string $value The actual property value, such as “Silver”
     * @return $this
     */

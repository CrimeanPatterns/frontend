...
/**
 * CancelledEvent Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class CancelledEvent implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'CancelledEvent';
     ...
     * Sets type.
     *
     * @param string $type Type of reservation. Value: `event`
     * @return $this
     */
     ...
     * Sets address.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Address $address the address of the event
     * @return $this
     */
     ...
     * Sets eventName.
     *
     * @param string $eventName event name such as the name of the restaurant
     * @return $this
     */
     ...
     * Sets eventType.
     *
     * @param int $eventType Type of the event. The possible values are:  **1** - for “Restaurant”  **2** - for “Meeting”  **3** - for “Show”  **4** - for “Event”
     * @return $this
     */
     ...
     * Sets phone.
     *
     * @param string $phone phone number associated with the event, such as restaurant’s phone number
     * @return $this
     */
     ...
     * Sets fax.
     *
     * @param string $fax fax number associated with the event, such as show organizer’s fax number
     * @return $this
     */
     ...
     * Sets guestCount.
     *
     * @param int $guestCount number of guests participating in the event
     * @return $this
     */
    public function setGuestCount($guestCount)
    {
        if (!is_null($guestCount) && ($guestCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $guestCount when calling CancelledEvent., must be bigger than or equal to 1.');
        }
     ...
     * Sets guests.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Person[] $guests arrays of guests participating in the event
     * @return $this
     */
     ...
     * Sets seats.
     *
     * @param string[] $seats Array of reserved seats
     * @return $this
     */

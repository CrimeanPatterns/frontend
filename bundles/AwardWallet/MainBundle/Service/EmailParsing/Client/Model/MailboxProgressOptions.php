...
/**
 * MailboxProgressOptions Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class MailboxProgressOptions implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'MailboxProgressOptions';
    ...
    public function listInvalidProperties()
    {
        ...
        if (mb_strlen($this->container['callbackUrl']) > 250) {

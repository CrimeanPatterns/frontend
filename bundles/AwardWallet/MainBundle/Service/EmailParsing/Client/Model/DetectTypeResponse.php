...
/**
 * DetectTypeResponse Class Doc Comment.
 *
 * @category Class
 * @description Detected information about email
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class DetectTypeResponse implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'DetectTypeResponse';
     ...
     * Sets type.
     *
     * @param string $type Tells you how this mailbox should be connected. Can be one of the options: `imap`, `google`, `microsoft`, `yahoo`, `aol`
     * @return $this
     */

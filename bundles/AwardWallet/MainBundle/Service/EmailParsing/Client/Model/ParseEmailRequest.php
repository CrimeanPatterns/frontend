...
/**
 * ParseEmailRequest Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ParseEmailRequest implements ModelInterface, \ArrayAccess
{
    public const DISCRIMINATOR = null;

    public const RETURN_EMAIL_HEADERS = 'headers';
    public const RETURN_EMAIL_ALL = 'all';
    public const RETURN_EMAIL_NONE = 'none';
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ParseEmailRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['returnEmail'] = $data['returnEmail'] ?? null;
     ...
     * @return string[]
     */
    public function getReturnEmailAllowableValues()
    {
        return [
            self::RETURN_EMAIL_HEADERS,
            self::RETURN_EMAIL_ALL,
            self::RETURN_EMAIL_NONE,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['returnEmail'] === null) {
            $invalidProperties[] = "'returnEmail' can't be null";
        }
        $allowedValues = $this->getReturnEmailAllowableValues();

        if (!is_null($this->container['returnEmail']) && !in_array($this->container['returnEmail'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'returnEmail', must be one of '%s'",
     ...
     * Sets email.
     *
     * @param string $email Full email source, including MIME headers and MIME body
     * @return $this
     */
    ...
    {
        return $this->container['returnEmail'];
    }

    /**
     * Sets returnEmail.
     *
     * @param string $returnEmail Indicates whether we should include the original email source in the response or not. There are three possible values:  - **headers** - include only the headers of the email  - **all** - include the entire email  - **none** - do not include the email in the response
     * @return $this
     */
    public function setReturnEmail($returnEmail)
    {
        ...
        if (!in_array($returnEmail, $allowedValues, true)) {
            throw new \InvalidArgumentException(sprintf("Invalid value for 'returnEmail', must be one of '%s'", implode("', '", $allowedValues)));
        }
        $this->container['returnEmail'] = $returnEmail;
     ...
     * Sets userData.
     *
     * @param string $userData Any text. We will return this text in the response field untouched. You can send your internal message id, or any other data. It can also be used for troubleshooting with our support team as you can reference that value so that we can easily identify the email you are inquiring about.
     * @return $this
     */

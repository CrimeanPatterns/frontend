...
class EmailInfo implements ModelInterface, \ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'from' => '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\EmailAddress',
        'to' => 'object[]',
        'cc' => 'object[]',
        'subject' => 'string',
    ...
    protected static $setters = [
        ...
        'cc' => 'setCc',
        'subject' => 'setSubject',
        'receivedDateTime' => 'setReceivedDateTime',
        'nested' => 'setNested',
        'userEmail' => 'setUserEmail',
        'mailboxId' => 'setMailboxId',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['receivedDateTime'] = $data['receivedDateTime'] ?? null;
        $this->container['nested'] = $data['nested'] ?? null;
        $this->container['userEmail'] = $data['userEmail'] ?? null;
        $this->container['mailboxId'] = $data['mailboxId'] ?? null;
    }
     ...
     * Gets from.
     *
     * @return \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\EmailAddress
     */
     ...
     * Sets from.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\EmailAddress $from the sender’s name (if exists) and the email address of the sender
     * @return $this
     */
     ...
     * Sets to.
     *
     * @param object[] $to an array of email recipients listed in the `To:` field of the email
     * @return $this
     */
     ...
     * Sets cc.
     *
     * @param object[] $cc an array of email recipients listed in the `Cc:` field of the email (if any)
     * @return $this
     */
    ...
    /**
     * Gets receivedDateTime.
     *
     * @return string
     */
    public function getReceivedDateTime()
    {
        return $this->container['receivedDateTime'];
    }

    /**
     * Sets receivedDateTime.
     *
     * @param string $receivedDateTime Date and time when the email was received in the mailbox in the `YYYY-MM-DDThh:mm:ss` format. The time will be in UTC+0 time zone.
     * @return $this
     */
    public function setReceivedDateTime($receivedDateTime)
    {
        $this->container['receivedDateTime'] = $receivedDateTime;
     ...
     * Sets nested.
     *
     * @param bool $nested set to ‘true’ if this email was received as an attachment to another email, that was actually submitted, and ‘false’ otherwise
     * @return $this
     */
     ...
     * Sets userEmail.
     *
     * @param string $userEmail Presumable email address of the actual end user. This email address may be parsed from the email headers (from, to, cc) or from the email body.
     * @return $this
     */
    ...
    {
        return $this->container['mailboxId'];
    }

    /**
     * Sets mailboxId.
     *
     * @param int $mailboxId Filled in with mailbox id, if this message was downloaded from mailbox added with /mailboxes/ api
     * @return $this
     */
    public function setMailboxId($mailboxId)
    {
        $this->container['mailboxId'] = $mailboxId;

...
/**
 * UpdateOAuthMailboxRequest Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class UpdateOAuthMailboxRequest implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'UpdateOAuthMailboxRequest';
    ...
    public function setCallbackUrl($callbackUrl)
    {
        if (!is_null($callbackUrl) && (mb_strlen($callbackUrl) > 250)) {
            throw new \InvalidArgumentException('invalid length for $callbackUrl when calling UpdateOAuthMailboxRequest., must be smaller than or equal to 250.');
        }
    ...
    public function setAccessToken($accessToken)
    {
        if (!is_null($accessToken) && (mb_strlen($accessToken) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $accessToken when calling UpdateOAuthMailboxRequest., must be smaller than or equal to 4000.');
        }
    ...
    public function setRefreshToken($refreshToken)
    {
        if (!is_null($refreshToken) && (mb_strlen($refreshToken) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $refreshToken when calling UpdateOAuthMailboxRequest., must be smaller than or equal to 2000.');
        }

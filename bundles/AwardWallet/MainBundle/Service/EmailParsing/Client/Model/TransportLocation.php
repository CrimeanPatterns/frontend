...
/**
 * TransportLocation Class Doc Comment.
 *
 * @category Class
 * @description This object describes the transportation departure and arrival events
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class TransportLocation implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'TransportLocation';
    ...
    {
        $this->container['stationCode'] = $data['stationCode'] ?? null;
        $this->container['name'] = $data['name'] ?? null;
        $this->container['localDateTime'] = $data['localDateTime'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['localDateTime'] === null) {
            $invalidProperties[] = "'localDateTime' can't be null";
        }
    ...
    {
        return $this->container['stationCode'];
    }

    /**
     * Sets stationCode.
     *
     * @param string $stationCode This attribute shows the bus station or train station or port code as it shows up on the email. This field is not validated.
     * @return $this
     */
    public function setStationCode($stationCode)
    {
        $this->container['stationCode'] = $stationCode;
     ...
     * Sets name.
     *
     * @param string $name Station or location name
     * @return $this
     */
    ...
    {
        return $this->container['localDateTime'];
    }

    /**
     * Sets localDateTime.
     *
     * @param string $localDateTime local date and time of arrival or departure (depending on the type of this location)
     * @return $this
     */
    public function setLocalDateTime($localDateTime)
    {
        $this->container['localDateTime'] = $localDateTime;
     ...
     * Sets address.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Address $address object defining the address of this location
     * @return $this
     */

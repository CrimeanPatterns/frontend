...
/**
 * CruiseDetails Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class CruiseDetails implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'CruiseDetails';
    ...
    protected static $setters = [
        ...
        'room' => 'setRoom',
        'ship' => 'setShip',
        'shipCode' => 'setShipCode',
        'voyageNumber' => 'setVoyageNumber',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['deck'] = $data['deck'] ?? null;
        $this->container['room'] = $data['room'] ?? null;
        $this->container['ship'] = $data['ship'] ?? null;
        $this->container['shipCode'] = $data['shipCode'] ?? null;
        $this->container['voyageNumber'] = $data['voyageNumber'] ?? null;
    }
     ...
     * Sets description.
     *
     * @param string $description Cruise description, such as “7-Day Eastern Caribbean from Orlando (Port Canaveral)”
     * @return $this
     */
     ...
     * Sets deck.
     *
     * @param string $deck Name of the deck, i.e. “The Haven Stateroom”
     * @return $this
     */
    public function setDeck($deck)
    {
        $this->container['deck'] = $deck;
     ...
     * Sets ship.
     *
     * @param string $ship The name of the ship, i.e. “Norwegian Epic”
     * @return $this
     */
    ...
    {
        return $this->container['shipCode'];
    }

    /**
     * Sets shipCode.
     *
     * @param string $shipCode This is usually a two-letter code that identifies the ship
     * @return $this
     */
    public function setShipCode($shipCode)
    {
        $this->container['shipCode'] = $shipCode;
    ...
    {
        return $this->container['voyageNumber'];
    }
     ...
     * @return $this
     */
    public function setVoyageNumber($voyageNumber)
    {
        $this->container['voyageNumber'] = $voyageNumber;

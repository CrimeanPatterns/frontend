...
/**
 * OAuthMailbox Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class OAuthMailbox extends Mailbox
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'OAuthMailbox';
     ...
     * Sets email.
     *
     * @param string $email the email address of the mailbox that was added as part of the request
     * @return $this
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 120)) {
            throw new \InvalidArgumentException('invalid length for $email when calling OAuthMailbox., must be smaller than or equal to 120.');
        }

...
class ImapMailbox extends Mailbox
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ImapMailbox';
     ...
     * Sets host.
     *
     * @param string $host the IMAP address of the server where mailbox is hosted
     * @return $this
     */
    public function setHost($host)
    {
        if (!is_null($host) && (mb_strlen($host) > 120)) {
            throw new \InvalidArgumentException('invalid length for $host when calling ImapMailbox., must be smaller than or equal to 120.');
        }
     ...
     * Sets login.
     *
     * @param string $login The IMAP server login to connect to the mailbox. In most cases it should be the email address.
     * @return $this
     */
    public function setLogin($login)
    {
        if (!is_null($login) && (mb_strlen($login) > 120)) {
            throw new \InvalidArgumentException('invalid length for $login when calling ImapMailbox., must be smaller than or equal to 120.');
        }
     ...
     * Sets secure.
     *
     * @param bool $secure Shows the value (true or false) for connection type that you passed to us when adding the mailbox. If it was not set then it is true by default.
     * @return $this
     */

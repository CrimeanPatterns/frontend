...
/**
 * IssuingAirline Class Doc Comment.
 *
 * @category Class
 * @description Any air ticket is always issued by some airline, this object defines the airline that actually issued the ticket.
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class IssuingAirline implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'IssuingAirline';
     ...
     * Sets airline.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Airline $airline object describing the airline that issued the ticket
     * @return $this
     */
     ...
     *
     * @param string $confirmationNumber PNR which corresponds to the airline that issued the ticket
     * @return $this
     */
     ...
     * Sets ticketNumbers.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParsedNumber[] $ticketNumbers in case if there are multiple travelers, all of their ticket numbers will be listed in this array
     * @return $this
     */
     ...
     * Sets phoneNumbers.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\PhoneNumber[] $phoneNumbers Contact phone numbers
     * @return $this
     */

...
/**
 * OperatingCarrier Class Doc Comment.
 *
 * @category Class
 * @description Whenever the operating airline is different from the airline listed on the ticket (next to the flight number), that operating airline flight info would be listed in this object as the operating carrier. Don’t confuse this with a wet lease airline.
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class OperatingCarrier implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'OperatingCarrier';
     ...
     * Sets airline.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Airline $airline object describing the operating airline if this airline is different from the one that was listed on the passenger’s ticket
     * @return $this
     */
     ...
     * Sets flightNumber.
     *
     * @param string $flightNumber Operating airline flight number
     * @return $this
     */
     ...
     *
     * @param string $confirmationNumber PNR issued by the operating airline, in most cases will be unknown, i.e. `null`
     * @return $this
     */

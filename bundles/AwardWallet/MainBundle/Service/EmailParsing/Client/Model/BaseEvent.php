 ...
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class BaseEvent implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'BaseEvent';
    ...
    public function setGuestCount($guestCount)
    {
        if (!is_null($guestCount) && ($guestCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $guestCount when calling BaseEvent., must be bigger than or equal to 1.');
        }

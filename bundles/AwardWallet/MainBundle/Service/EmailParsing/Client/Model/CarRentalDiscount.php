...
/**
 * CarRentalDiscount Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class CarRentalDiscount implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'CarRentalDiscount';
     ...
     * Sets name.
     *
     * @param string $name discount name, such as “Your Rate has been discounted based on the Hertz CDP provided”
     * @return $this
     */
     ...
     * Sets code.
     *
     * @param string $code Discount code, such as “AAA SOUTHERN NEW ENGLAND”
     * @return $this
     */

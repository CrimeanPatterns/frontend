 ...
 *
 * @category Class
 * @description If there is a loyalty program associated with this reservation, the details specific to that program will be listed in this object.
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ProviderInfo implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ProviderInfo';
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
        'code' => 'string',
        'accountNumbers' => '\AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParsedNumber[]',
    ...
    protected static $getters = [
        ...
        'earnedRewards' => 'getEarnedRewards',
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['accountNumbers'] = $data['accountNumbers'] ?? null;
        $this->container['earnedRewards'] = $data['earnedRewards'] ?? null;
    }
     ...
     * Sets code.
     *
     * @param string $code alpha-numeric value with no spaces that uniquely identifies any given loyalty program within AwardWallet
     * @return $this
     */
    ...
    {
        return $this->container['accountNumbers'];
    }

    /**
     * Sets accountNumbers.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\ParsedNumber[] $accountNumbers Array of related loyalty program account numbers
     * @return $this
     */
    public function setAccountNumbers($accountNumbers)
    {
        $this->container['accountNumbers'] = $accountNumbers;
    ...
    {
        return $this->container['earnedRewards'];
    }

    /**
     * Sets earnedRewards.
     *
     * @param string $earnedRewards Rewards earned for booking the reservation
     * @return $this
     */
    public function setEarnedRewards($earnedRewards)
    {
        $this->container['earnedRewards'] = $earnedRewards;

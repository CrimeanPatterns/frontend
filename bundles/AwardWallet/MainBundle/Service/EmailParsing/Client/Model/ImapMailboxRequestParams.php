...
/**
 * ImapMailboxRequestParams Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ImapMailboxRequestParams implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ImapMailboxRequestParams';
    ...
    public function setHost($host)
    {
        if (!is_null($host) && (mb_strlen($host) > 120)) {
            throw new \InvalidArgumentException('invalid length for $host when calling ImapMailboxRequestParams., must be smaller than or equal to 120.');
        }
    ...
    public function setLogin($login)
    {
        if (!is_null($login) && (mb_strlen($login) > 120)) {
            throw new \InvalidArgumentException('invalid length for $login when calling ImapMailboxRequestParams., must be smaller than or equal to 120.');
        }
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 250)) {
            throw new \InvalidArgumentException('invalid length for $password when calling ImapMailboxRequestParams., must be smaller than or equal to 250.');
        }

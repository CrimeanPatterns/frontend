...
/**
 * CarRentalLocation Class Doc Comment.
 *
 * @category Class
 ...
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class CarRentalLocation implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'CarRentalLocation';
     ...
     * Sets address.
     *
     * @param \AwardWallet\MainBundle\Service\EmailParsing\Client\Model\Address $address rental car facility address
     * @return $this
     */
     ...
     * Sets localDateTime.
     *
     * @param string $localDateTime scheduled date and time of the car pickup or drop-off in the time zone of the location of the rental car facility
     * @return $this
     */
     ...
     * Sets openingHours.
     *
     * @param string $openingHours rental car facility hours of operation
     * @return $this
     */
     ...
     * Sets phone.
     *
     * @param string $phone rental car facility phone number
     * @return $this
     */
     ...
     * Sets fax.
     *
     * @param string $fax rental car facility fax number
     * @return $this
     */

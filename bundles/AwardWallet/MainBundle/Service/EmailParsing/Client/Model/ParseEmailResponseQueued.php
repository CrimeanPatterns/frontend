...
/**
 * ParseEmailResponseQueued Class Doc Comment.
 *
 * @category Class
 * @author   Swagger Codegen team
 * @see     https://github.com/swagger-api/swagger-codegen
 */
class ParseEmailResponseQueued implements ModelInterface, \ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'ParseEmailResponseQueued';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['requestIds'] === null) {
            $invalidProperties[] = "'requestIds' can't be null";
        }
     ...
     * Sets status.
     *
     * @param string $status The status of the request. Can have one of two values: - **queued** - the email has been placed into the AwardWallet’s queue, as soon as it is processed the results will be available and will be sent to your callback URL. - **error** -  the email has not been placed into the AwardWallet’s queue, see the `errorMessage` field for more details.
     * @return $this
     */
     ...
     * Sets errorMessage.
     *
     * @param string $errorMessage if you get an error in the `status` attribute the actual error message will be available in this field
     * @return $this
     */
     ...
     * Sets requestIds.
     *
     * @param string[] $requestIds Collection of request IDs, which can be used to retrieve the parsing results using the [`/getResults/{requestID}`](#method-email_Parsing_2) method and also these request IDs will be sent with the response to your callback URL. Multiple request IDs could be returned if the submitted email contained one or more nested (attached) emails. Each ID can be used separately to retrieve the parsing results of each of these emails.
     * @return $this
     */

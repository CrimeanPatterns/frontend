...
/**
 * @deprecated use AsyncConsumer instead
 */
class FlightNotificationExecutor implements ExecutorInterface, TranslationContainerInterface
{
    ...
    /**
     * @param FlightNotificationTask $task
     */
    ...
    private function sendEmail(
        ...
        $this->emailSender->execute(new SendEmailTask(
            $tripSegment->getId(),
            $user->getId(),
            $fm ? $fm->getId() : null,

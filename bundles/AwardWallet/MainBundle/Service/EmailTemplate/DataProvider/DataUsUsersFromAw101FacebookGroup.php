...
class DataUsUsersFromAw101FacebookGroup extends AbstractFailTolerantDataProvider
{
    public function getQueryOptions()
    {
        ...
        array_walk($options, function ($option) use ($fullnames) {
            ...
            $option->hasUserFullname = $fullnames;
        });
    ...
    public function getDescription(): string
    {
        return 'Users from US or from unknown country (detected by last logon ip (if any) or registration ip) <br/>
                whose full name DOES exists in list exported (last export: April 16, 2018) from facebook aw101 group';
    }

    public function getTitle(): string
    {
        return 'US users from Facebook Aw101 group (date: April 16, 2018)';
    }

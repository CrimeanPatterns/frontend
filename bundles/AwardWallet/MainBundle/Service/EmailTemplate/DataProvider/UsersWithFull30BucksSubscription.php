 ...
 */
class UsersWithFull30BucksSubscription extends AbstractAwPlusRelatedDataProvider
{
    public function getQueryOptions()
    {
        ...
        array_walk($options, function ($option) {
            ...
            $option->hasSubscriptionType = Options::SUBSCRIPTION_TYPE_FULL_30;
    ...
    {
        return 'All users with Full $30 subscription';
    }
    ...
    protected function isUserValid(Usr $user, ?Cart $cart): bool
    {
        ...
        return
            ...
            && $cart->getItemsByType([AwPlusSubscription::TYPE]);
    }

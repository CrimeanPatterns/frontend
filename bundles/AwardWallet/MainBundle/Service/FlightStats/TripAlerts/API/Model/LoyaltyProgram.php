...
class LoyaltyProgram implements ModelInterface, \ArrayAccess
{
    ...
    {
        $this->container['programCode'] = $data['programCode'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['programCode'] === null) {
            $invalidProperties[] = "'programCode' can't be null";
        }
     ...
     * Sets programCode.
     *
     * @param string $programCode The FlightStats code for the program. Currently supports FlightStats Airline codes only
     * @return $this
     */

...
class Ticket implements ModelInterface, \ArrayAccess
{
    ...
    {
        $this->container['ticketStock'] = $data['ticketStock'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ticketStock'] === null) {
            $invalidProperties[] = "'ticketStock' can't be null";
        }
    ...
    {
        return $this->container['ticketStock'];
    }

    /**
     * Sets ticketStock.
     *
     * @param string $ticketStock The 3 digit code for the airline (as assigned by IATA) issuing this ticket
     * @return $this
     */
    public function setTicketStock($ticketStock)
    {
        $this->container['ticketStock'] = $ticketStock;
     ...
     * Sets issueDate.
     *
     * @param \DateTime $issueDate The timestamp of when the ticket was issued (ISO datetime format eg yyyy-MM-ddTHH:mm:ss.SSSZ)
     * @return $this
     */

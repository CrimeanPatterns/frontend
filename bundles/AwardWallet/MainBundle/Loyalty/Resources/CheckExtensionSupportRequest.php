...
class CheckExtensionSupportRequest
{
    ...
    public function setIncludeReadyProviders(bool $includeReadyProviders): self
    {
        $this->includeReadyProviders = $includeReadyProviders;

        return $this;
    }

    public function isIncludeReadyProviders(): bool
    {
        return $this->includeReadyProviders;
    }
}

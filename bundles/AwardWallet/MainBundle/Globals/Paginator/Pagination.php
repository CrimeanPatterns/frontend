...
class Pagination extends AbstractPagination
{
    ...
    public function isSorted($key, array $params = [])
    {
        $params = array_merge($this->params, $params);

        return isset($params[$this->getPaginatorOption('sort_field_name')]) && $params[$this->getPaginatorOption('sort_field_name')] === $key;
    }

...
$html2text_elements = [];
$html2text_elements['the document'] = [true, true]; // drop first and last margins in the document - recommended: true,true
$html2text_elements['unknown element'] = [false, false, false, 0, 0, false, '', '', false, false, false]; // used for all unknown or default elements

// list all elements that need special (non-default) handling:
$html2text_elements['html'] = [true, false, false, 10, 10, false, '', '', false, false, false];
$html2text_elements['title'] = [true, false, false, 1, 1, false, '', "\r\n          --------------------", false, false, false];
$html2text_elements['script'] =
$html2text_elements['style'] =
$html2text_elements['datalist'] = [false, false, true, 0, 0, false, '', '', false, false, false];
$html2text_elements['h1'] = [true, false, false, 2, 2, false, '** ', ' **', false, false, false];
$html2text_elements['h2'] = [true, false, false, 2, 2, false, '*', '*', false, false, false];
$html2text_elements['h3'] = [true, false, false, 2, 2, false, '-', '-', false, false, false];
...
$html2text_elements['section'] = [true, false, false, 2, 2, false, '', '', false, false, false];
$html2text_elements['blockquote'] = [true, false, false, 2, 2, false, 'html2text_before_quote', '}}', true, false, false];
$html2text_elements['form'] = [true, false, false, 2, 2, false, 'html2text_before_form', '', true, false, false];
$html2text_elements['pre'] =
$html2text_elements['listing'] =
$html2text_elements['plaintext'] =
$html2text_elements['xmp'] = [true, true, false, 2, 2, false, '', '', false, false, false];
...
$html2text_elements['header'] = [true, false, false, 1, 1, false, '', '', false, false, false];
$html2text_elements['dt'] = [true, false, false, 1, 1, false, '* ', '', false, false, false];
$html2text_elements['th'] =
$html2text_elements['td'] = [true, false, false, 0, 0, true, "\t", '', false, false, true];
$html2text_elements['dd'] = [true, false, false, 1, 1, true, "        ", '', false, false, false];
$html2text_elements['ol'] = [true, false, false, 2, 2, false, '', '', false, false, false];
$html2text_elements['li'] = [true, false, false, 1, 1, true, 'html2text_before_li', '', true, false, false];
$html2text_elements['br'] = [true, false, false, 0, 0, false, "\r\n", '', false, false, false]; // use \r\n instead of margin - must not collapse
$html2text_elements['hr'] = [true, false, false, 1, 1, false, '          --------------------', '', false, false, false];
$html2text_elements['sup'] = [false, false, false, 0, 0, false, '^', '', false, false, false];
$html2text_elements['sub'] = [false, false, false, 0, 0, false, '[', ']', false, false, false];
$html2text_elements['s'] =
$html2text_elements['strike'] =
$html2text_elements['del'] = [false, false, false, 0, 0, false, '[DEL: ', ' :DEL]', false, false, false];
$html2text_elements['ins'] = [false, false, false, 0, 0, false, '[INS: ', ' :INS]', false, false, false];
$html2text_elements['strong'] =
$html2text_elements['b'] =
$html2text_elements['mark'] = [false, false, false, 0, 0, false, '*', '*', false, false, false];
$html2text_elements['em'] =
$html2text_elements['i'] = [false, false, false, 0, 0, false, '/', '/', false, false, false];
$html2text_elements['u'] = [false, false, false, 0, 0, false, '_', '_', false, false, false];
$html2text_elements['q'] = [false, false, false, 0, 0, false, '"', '"', false, false, false];
$html2text_elements['a'] = [false, false, false, 0, 0, false, 'html2text_before_link', '', true, false, false];
$html2text_elements['area'] = [false, false, false, 0, 0, false, 'html2text_before_area', '', true, false, false];
$html2text_elements['base'] = [false, false, false, 0, 0, false, 'html2text_before_base', '', true, false, false];
$html2text_elements['input'] = [false, false, false, 0, 0, false, 'html2text_before_input', '', true, false, false];
$html2text_elements['bb'] = [false, false, false, 0, 0, false, '[INPUT]', '', false, false, false];
$html2text_elements['isindex'] = [true, false, false, 2, 2, false, 'html2text_before_isindex', '', true, false, false];
$html2text_elements['textarea'] =
$html2text_elements['button'] =
$html2text_elements['select'] = [false, false, true, 0, 0, false, '[INPUT]', '', false, false, false];
$html2text_elements['img'] = [false, false, false, 0, 0, false, 'html2text_before_img', '', true, false, false];
...
function html2text_before_base($element, $index)
{
    if ($element->hasAttribute('href')) {
        ...
        foreach (['scheme', 'host', 'port', 'user', 'pass', 'path', 'query', 'fragment'] as $key) {
...
function html2text_resolve($href, $element)
{
    ...
    if ((!$href || preg_match("/^\#/u", $href)) && !$base['basefound']) {
        return '';
    } // relative or fragment url with no visible path - useless

    if (!$base['basefound']) {
        return $href;
    } // relative with visible path but no base - can't help that
...
function html2text($sourceStr, $isXML = false, $isfile = false)
{
    ...
    $DOM->h2t_base = ['scheme' => '', 'host' => '', 'port' => '', 'user' => '', 'pass' => '', 'path' => '', 'query' => '', 'fragment' => '', 'pathdir' => '', 'pathfile' => '', 'basefound' => ''];

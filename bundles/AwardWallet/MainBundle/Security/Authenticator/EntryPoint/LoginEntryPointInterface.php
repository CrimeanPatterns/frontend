...
interface LoginEntryPointInterface
{
    /**
     * Entry point unique identificator.
     */
    public function getId(): string;

    /**
     * Checks that entry point can process request.
     */
    ...
    /**
     * Whether request should be treated as authentication attempt.
     */

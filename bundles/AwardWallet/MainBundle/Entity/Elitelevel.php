 ...
 * @ORM\Entity(repositoryClass="AwardWallet\MainBundle\Entity\Repositories\ElitelevelRepository")
 */
class Elitelevel
{
    /**
     ...
     * @return Elitelevel
     */
    public function setAllianceelitelevelid(?Allianceelitelevel $allianceelitelevelid = null)
    {

...
//            $this->setProxyNetNut();
    ...
    public function LoadLoginForm()
    {
        ...
        $button = $this->waitForElement(WebDriverBy::xpath('//form[contains(@class, "iw-otp-username")]//silo-button[contains(text(), "Continue")]'), 0);
        $this->saveResponse();
        ...
        if (
            $this->waitForElement(WebDriverBy::xpath('//form[contains(@class, "iw-otp-username")]/div/silo-button[@disabled="true"]'), 0)
            && $this->waitForElement(WebDriverBy::xpath('//input[@id = "signInUsername"] | //*[@id = "username"]'), 0)
        ) {
            throw new CheckException('We were unable to sign you in. Please check your credentials and try again.', ACCOUNT_INVALID_PASSWORD);
        }

...
class TAccountCheckerOfficedepot extends TAccountChecker
{
    ...
    */
    ...
    {
        require_once __DIR__ . "/TAccountCheckerOfficedepotSelenium.php";

        return new TAccountCheckerOfficedepotSelenium();
...
//        $this->http->SetInputValue("autoLogin", "true");
    ...
    public function Parse()
    {
        ...
        if (!empty($this->responseDataRewards)) {
            ...
            /*
            $this->http->setCookie('_abck', $this->State['abck'], '.officedepot.com', '/');
            $abck = 'BABE1D0C52A12B688B9B42486C49720D~0~~-1~||0||~-1';
            $this->http->setCookie('_abck', $abck, '.officedepot.com', '/');
            */

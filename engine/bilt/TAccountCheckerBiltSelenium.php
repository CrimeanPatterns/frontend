...
use AwardWallet\Engine\bilt\QuestionAnalyzer;
...
class TAccountCheckerBiltSelenium extends TAccountChecker
{
    ...
    private const XPATH_QUESTION = "//span[contains(text(), 'Enter the ') and contains(text(), 'code we sent to ')]";
...
//            $login->sendKeys($this->AccountFields['Login']);
        ...
        if (!$pass) {
            ...
            $loginViaPassword = $this->isBackgroundCheck() && !$this->getWaitForOtc();

            if (!$loginViaPassword && $this->parseQuestion()) {

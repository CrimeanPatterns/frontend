...
//                $selenium->http->GetURL("https://www.ulta.com/auth/login?redirect=%2F&screen=login");
            ...
            $signIn = $selenium->waitForElement(WebDriverBy::xpath("//div[@class = 'LoginForm__Submit' or @class = 'SignIn__submit']/button | //button[normalize-space(text()) = 'SIGN IN'] | //button[normalize-space(text()) = 'Sign in']"), 0);

...
class CarRental extends \TAccountChecker
{
    ...
    public static $dictionary = [
        ...
        "fr" => [
            ...
            "Pickup Date & Time"            => "Date et heure de retrait",
            "Pickup Location"               => "Lieu de retrait",
            "Return Date & Time"            => "Date et heure de retour",
            "Return Location"               => "Lieu de retour",
            "Directions to pickup location" => "Directions pour la station de location",
            "Hours of Operation"            => "Heures ouvrables",
            //			"Phone" => "",
            "Vehicle Information" => "Informations sur le véhicule",
            "Driver's Name"       => "Nom du conducteur",
            "Total Charges"       => "Prix total estimé",
            // "To Pay on Arrival"   => "",

            "Alamo Insiders #" => ['N° Emerald Club'],
        ],
    ];

...
class TAccountCheckerSeleniumAllegiant extends TAccountChecker
{
        ...
        */
        ...
        if ($errorEl && $error = $errorEl->getText()) {
            ...
            if (stripos($error, 'Wrong email or password') !== false
                ...
                || stripos($error, 'Email AddressInvalid email or password') !== false
            ) {
    ...
    public function Parse()
    {
        ...
        $this->SetProperty('TotalVouchers', $this->http->FindSingleNode('//span[@data-hook="dashboard-total-vouchers-amount"]'));

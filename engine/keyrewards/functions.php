...
//        // TODO: debug
    ...
    public function Parse()
    {
        ...
        foreach ($response->response->entity->keyAndCreditCardCertificateBaseList[0]->certificates as $certificate) {
            ...
            $expirationDate = $certificate->certificateExpirationLocalDate->monthValue . '/' . $certificate->certificateExpirationLocalDate->dayOfMonth . '/' . $certificate->certificateExpirationLocalDate->year;
            // barcode  // refs #8508

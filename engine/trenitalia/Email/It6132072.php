...
class It6132072 extends \TAccountChecker
{
    ...
    public static function assignRegion(string $nameStation, ?string $trainType): void
    {
        ...
        if (preg_match("/(?:\bNapoli Centrale\b|\bMilano\b|\bVenezia\b|\bFoggia\b|\bBarile\b|\bPavia\b|\bSavona\b|\bRoma\b|\bRosta\b|\bLodi\b|\bAvio\b|\bNapoli Piazza\b|\bPompei\b|\bAncona\b|\bSorrento\b|\bSenigallia\b|\bPaola\b)/i", $nameStation)) {
            self::$region = 'Italia';
            self::$regionCode = 'it';
        } else {
            self::$region = 'Europe';

...
//        $this->http->GetURL('https://experience.velocityfrequentflyer.com/my-velocity/my-activity/summary');
    ...
    {
        return "https://www.virginaustralia.com/au/en/?screen=mytrips";
    }
    ...
    public function CheckConfirmationNumberInternal($arFields, &$it)
    {
        ...
        //$this->seleniumConfNo();
        $this->http->GetURL('https://www.virginaustralia.com/au/en/?screen=mytrips');
        ...
        if (!isset($data->data->getMYBTripDetails->originalResponse->pnr)) {
            return null;
        }

        $this->parseItinerary($data->data->getMYBTripDetails->originalResponse->pnr);

...
{
    public $mailFiles = "tapportugal/it-688824843.eml, tapportugal/it-689093912.eml, tapportugal/it-771303063.eml, tapportugal/it-772608085.eml, tapportugal/it-908332646.eml";
    ...
    public static $providers = [
        'tapportugal' => [
            ...
            'subject' => [
                ...
                // pt
                'Informação importante: A sua reserva TAP Air Portugal com a referência', // + foi alterada
            ],
        ...
        'malaysia' => [
            'from'    => '@yourbooking.malaysiaairlines.com',
            'subject' => [
                // en
                'Important information about your flight',
            ],
            'bodyText' => ['Malaysia Airlines booking'],
        ],
    ];
    ...
    public static $dictionary = [
        "en" => [
            'Changes to your booking' => ['Changes to your booking', 'find below the confirmation of your new flight:', 'schedule change'],
            'confNumber'              => 'Booking reference',
            // 'Dear ' => '',
            'Your Previous Itinerary' => ['Your Previous Itinerary'],
            'Duration:'               => ['Duration:', 'Duration'],
            'Your new itinerary'      => ['Your new itinerary', 'YOUR NEW ITINERARY', 'Your itinerary', 'YOUR ITINERARY', 'NEW ITINERARY', 'New itinerary', 'Your New Itinerary'],
        ],
        "pt" => [
            ...
            'Your new itinerary'      => ['Seu novo itinerário', 'SEU NOVO ITINERÁRIO', 'O seu itinerário', 'O SEU ITINERÁRIO', 'O seu novo itinerário', 'O SEU NOVO ITINERÁRIO'],
        ],
        "es" => [
    ...
    public function detectEmailFromProvider($from)
    {
        foreach (self::$providers as $provider) {
            if (!empty($provider['from']) && preg_match("/{$provider['from']}/", $from)) {
                return true;
            }
        }
    ...
    public function ParseFlight(Email $email): void
    {
        ...
        if (!empty($traveller) && !preg_match("/^\s*{$this->opt(['Customer', 'Cliente'])}\s*$/ui", $traveller)) {
            $f->general()
                ->traveller(preg_replace("/^(?:Mr|Ms|Mrs)/", "", $traveller));
        }

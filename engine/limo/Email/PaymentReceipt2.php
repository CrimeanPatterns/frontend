...
{
    public $mailFiles = "limo/it-143993503.eml, limo/it-144712170.eml, limo/it-895517651.eml";
    ...
    private function parseEmailHtml(Email $email)
    {
        ...
        if (empty($putime) & empty($dotime)
            && $this->http->XPath->query("//tr[*[1][{$this->eq($this->t("CONF #"))}] and *[2][{$this->eq($this->t("DATE & TIME(S)"))}]]/following-sibling::tr[normalize-space()][1]/*[2]//text()[normalize-space()]")->length === 2
        ) {
            $putime = $this->http->FindSingleNode("//tr[*[1][{$this->eq($this->t("CONF #"))}] and *[2][{$this->eq($this->t("DATE & TIME(S)"))}]]/following-sibling::tr[normalize-space()][1]/*[2]/descendant::text()[normalize-space()][2]");
        }
        $startDate = null;

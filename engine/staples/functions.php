...
//            throw new CheckRetryNeededException(2, 1);
        ...
        // not a member
        if (strstr($this->http->currentUrl(), '/easyrewardsoverview')
                    || strstr($this->http->currentUrl(), 'https://www.staples.com/personalinfo/rewards?catalogId=10051&langId=-1&storeId=10001')

...
//        return preg_match('/Your.* statement/i', $headers['subject']) > 0;
    ...
    public function detectEmailByBody(\PlancakeEmailParser $parser)
    {
        ...
        return $this->http->XPath->query('//*[' . $this->contains([
            'Your statement is now ready',
            'Statement Balance:',
            ', thank you for being a Card Member',
            ', thank you for being a valued Card Member',
            'Your Re-authentication Key:', 're-authentication key',
            'Remember that you can earn 1 Membership Rewards®',
        ])
                . '] | //a[normalize-space()="View Statement"] | //img[contains(@src, "logo_rewardschecking")]')->length > 0;
    }

...
class TAccountCheckerNiugini extends TAccountChecker
{
    ...
    public function Parse()
    {
        ...
        if ($this->ErrorCode == ACCOUNT_ENGINE_ERROR) {
            $this->http->GetURL("https://www.airniugini.com.pg/destinations-loyalty/loyalty-hub/");
            $balance = $this->http->FindSingleNode("//div[contains(@class, 'subheader__points-count')]");
            $this->SetBalance($balance);
        }
    }

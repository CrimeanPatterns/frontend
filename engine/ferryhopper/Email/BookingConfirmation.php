...
{
    public $mailFiles = "ferryhopper/it-150218669.eml, ferryhopper/it-158322253.eml, ferryhopper/it-911636506.eml, ferryhopper/it-98264154.eml, ferryhopper/it-98461270.eml";
    public $subjects = [
        // en
    ...
    public static $dictionary = [
        ...
        "el" => [
            ...
            'Payment details'  => ['Στοιχεία πληρωμής', 'Ανάλυση κόστους'],
...
//         $this->logger->debug('$date = '.print_r( $date,true));
        ...
        $in = [
            ...
            '#^\w+[.]?\,\s*(\d+)\s*(\w+)\s*([\d\:]+)$#u',
            // Fri, 16 July 2025 15:00; mar., 20 juillet 17:00

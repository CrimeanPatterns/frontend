...
class TAccountCheckerAna extends TAccountChecker
{
    ...
    {
        $result = [];
        $this->http->GetURL('https://aswbe.ana.co.jp/webapps/servicing/booking-search?CONNECTION_KIND=LAX&LANG=en');
        $this->http->PostURL('https://space.ana.co.jp/aswbe-initialization/api/v1/initialization',
            '{"connectionKind":"LAX","lang":"en","userAgent":"'.$this->http->userAgent.'"}', [
                'Authorization' => 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJodHRwczovL2FuYS5jby5qcCIsInV1aWQiOiJjNzVhMGQ2My01M2U2LTQ1ZDMtYTA5Ny00YWQ4YTkxOGVhNTYifQ.LqHaBVkEPxxE1RrM7SLPxXlh5peXYmZM2pMDIXdVie0'
            ]);
        $this->http->GetURL('https://space.ana.co.jp/aswbe-servicing/api/v1/orders/get-order-list');

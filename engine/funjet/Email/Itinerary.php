...
class Itinerary extends \TAccountChecker
{
    ...
    private $reFrom = [
        ...
        'uniorlres'      => ['universalorlando.com'],
    ];

    private $reSubject = [
        'Reservation Confirmation', // funjet, travimp, appleva, uniorlres
    ...
    private $providerDetect = [
        ...
        'uniorlres'        => ['universalorlandovacations.com'],
    ];
    ...
    {
        return ['ccaribbean', 'funjet', 'mileageplus', 'rapidrewards', 'alaskaair', 'tedge', 'hawaiian', 'travimp', 'appleva', 'virtuoso', 'goldpassport', 'uniorlres'];
    }

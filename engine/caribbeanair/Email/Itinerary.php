...
class Itinerary extends \TAccountChecker
{
    ...
    private function parseHtml(&$itineraries): void
    {
        ...
        $seatsByFlight = [];
        $seatsText = implode("\n", $this->http->FindNodes("//tr[ *[1][{$this->eq("Name")}] and *[3][{$this->contains("Seat")}] ]/following-sibling::tr[normalize-space()]/*[3]//text()[normalize-space()]"
            . " | //tr[ *[1][{$this->eq("Name")}] and *[2][{$this->contains("Seat")}] ]/following-sibling::tr[normalize-space()]/*[2]//text()[normalize-space()]"));

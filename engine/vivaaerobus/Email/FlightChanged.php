...
class FlightChanged extends \TAccountChecker
{
    ...
    public static $dictionary = [
        'es' => [
            ...
            'confNumber-contains'     => ['clave de reservación', "clave de reservación"], //different
            'Departs'                 => ['Salida'],
            'Arrives'                 => 'Llegada',
            'PREVIOUS FLIGHT DETAILS' => 'DETALLE VUELO ANTERIOR',
            'Flight'                  => 'Vuelo',
            'Operated by'             => 'Operado por',
            'Dear'                    => ['Estimado(a)', 'Dear', 'Hola'], // + en
            'UPDATED FLIGHT DETAILS'  => 'Información actualizada de vuelo',
        ],
        'en' => [

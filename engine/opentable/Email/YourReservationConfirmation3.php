...
class YourReservationConfirmation3 extends \TAccountChecker
{
    ...
    public static $dictionary = [
        ...
        "fr" => [ // it-63573075.eml
            ...
            "Confirmation #"      => ["Numéro de confirmation", "Réservation Nº", "Confirmation numéro", "Référence de réservation"],
        ...
        "it" => [
            "Name:"                 => ["Nome:"],
            "Confirmation #"        => ["Conferma n.:", "Conferma n.", "Prenotazione n."],
    ...
    public function detectEmailByBody(\PlancakeEmailParser $parser)
    {
        ...
        $this->logger->error('YES'); // For what?
    ...
    private function parseHtml(Email $email): void
    {
        ...
        // StartDate
        $startsDate = strtotime($this->normalizeDate($this->http->FindSingleNode("//text()[{$this->starts($this->t("Table for "))} and following::tr[{$this->starts($this->t('Name:'))} or {$this->starts($this->t('First Name:'))}]]/ancestor::tr[1]", null, true, "# (?:\d+ on|para \d+|\d+ pour|\d+ per|Person\(en\) am|\d+ il giorno|\d+ op),? (.+)#")));

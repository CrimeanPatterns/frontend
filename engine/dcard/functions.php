...
class TAccountCheckerDcard extends TAccountChecker
{
    ...
    public function InitBrowser()
    {
        ...
        //$this->setProxyGoProxies(null, 'de', null, null, 'https://www.deutschlandcard.de');
    ...
    public function LoadLoginForm()
    {
        ...
        */
        ...
        if ($captcha !== false) {
            $headers['x-recaptcha-v3'] = $captcha;
        }

        $headers['Referer'] = 'https://www.deutschlandcard.de/logout';
        $headers['x-banner_ab-request-id'] = 'a';
        $headers['x-trace-request-id'] = 'b01f501f-e707-4fb7-86a6-3008bf91d760';
        ...
        $this->http->PostURL("https://www.deutschlandcard.de/api/v1/auth/connect/token", json_encode($data), $headers);
    ...
    protected function parseReCaptcha($key = null, $isV3 = false)
    {
        ...
        if ($isV3) {
            ...
            $postData = [
                ...
                "websiteURL"   => 'https://www.deutschlandcard.de/logout' ?? $currentURL ?? $this->http->currentUrl(),
                "websiteKey"   => $key,
                "minScore"     => 0.9,
                "pageAction"   => "login",
            ];

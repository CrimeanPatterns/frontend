...
{
    public $mailFiles = "etihad/it-419101182.eml, etihad/it-419368004.eml, etihad/it-420152872.eml, etihad/it-420691170.eml, etihad/it-681320762-fr.eml, etihad/it-777639639-it.eml, etihad/it-788482287-es.eml, etihad/it-798674592-it.eml, etihad/it-804284259.eml, etihad/it-809022821-pt.eml, etihad/it-817535952-pt.eml, etihad/it-844742956.eml, etihad/it-923805402.eml, etihad/it-923805405.eml";
    public $lang = 'en';
    ...
    private $detectSubject = [
        ...
        'Your new details for',
        'Your flight reference',
        'time change: Your flight',
    ...
    private function parseEmailHtml(Email $email, string $subject): void
    {
        ...
        foreach ($nodes as $root) {
            ...
            if (preg_match($re, $routeText, $m) || preg_match($re2, $routeText, $m) || preg_match($re3, $routeText, $m)) {

...
class YourStatement extends \TAccountChecker
{
    ...
    public $subjects = [
        'Your RedCard statement is available', 'Your Manage My RedCard One Time Passcode', 'Your Target Circle Card one-time passcode',
    ];
    ...
    public function detectEmailByBody(PlancakeEmailParser $parser)
    {
        ...
        if ($this->http->XPath->query('//text()[contains(., "Your Manage my Target Circle Card One Time Passcode")]')->length > 0) {
            return true;
        }
    ...
    public function detectEmailFromProvider($from)
    {
        return preg_match('/[@.]myredcard\.target\.com/', $from) > 0
            || preg_match('/[@.]mycirclecard\.target\.com/', $from) > 0;
    }

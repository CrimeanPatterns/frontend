...
//        if (!$this->http->ParseForm('login-form'))
    ...
    public function Parse()
    {
        ...
        $this->lastName = $mariner->lastName;
        // Name
    ...
    {
        $result = [];
        $this->http->PostURL('https://www.hollandamerica.com/api/v2/mariner/upcomingbookings', json_encode([
            'marinerId'      => $this->Properties['MarinerNumber'],
        ]), [
        ...
        foreach ($response->data as $item) {
            $this->http->GetURL("https://www.hollandamerica.com/secondary/api/guest/v1.0.0/booking/companyCode/HAL/bookingNumber/{$item->bookingNumber}?ssvInfo=true&tkDiningInfo=false", [
                'Accept'        => 'application/json',
            ]);

...
class HotelReservations extends \TAccountChecker
{
    ...
    private static $dict = [
        'en' => [
            'confirmation-starts'           => ['Confirmation Number', 'CONFIRMATION NUMBER', 'Confirmation #', 'Confirmation:', 'Confirmation No:', 'Hotel Confirmation Number:', 'PROPERTY CONFIRMATION NUMBER:', 'Confirmation number', 'Hotel Engine #:', 'Confirmation', 'Your booking #', 'Your Booking #', 'YOUR BOOKING #', 'Confirmation', 'CONFIRMATION:',
                'Itinerary Confirmation Number:', 'Confirmation Number:', 'CONFIRMATION #', ],
            ...
            'checkin/outTime'               => ['Check-In/Out Time', 'CHECK IN / OUT TIME:', 'Check in / Check out', 'Check In / Check Out', 'CHECK-IN / OUT'],
            ...
            'Nightly Rate per Room:'        => ['Nightly Rate per Room:', 'Nightly Rate per Room', 'Nightly rate', 'NIGHTLY RATE(S)'],
        ],
    ];
    ...
    private function parseHtml(Email $email): void
    {
        ...
        if ($cancelPolicy) {
            ...
            || preg_match("#^Standard cancellation policy is (\d+) hours#i", $cancelPolicy, $m)
            ) {

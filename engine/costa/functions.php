...
//        $this->http->setCookie("_abck", "93775F7160631E743D63E0036F7B4D4C~0~~-1~||-1||~-1", ".costa.co.uk");
    ...
    private function getCookiesFromSelenium($retry = false)
    {
        ...
        try {
            ...
            $login = $selenium->waitForElement(WebDriverBy::xpath('//input[@name = "signInName"]'), 10);
            ...
            $btn = $selenium->waitForElement(WebDriverBy::xpath('//button[@id = "next" and not(@disabled)]'), 3);
            ...
            $btn->click();
            $selenium->waitForElement(WebDriverBy::xpath('//div[contains(text(), "Beans total")]'), 10);
            $this->savePageToLogs($selenium);
            ...
            foreach ($requests as $n => $xhr) {
                ...
                if (stristr($xhr->request->getUri(), 'web.costa-loyalty-platform.com/loyalty/v1/')) {

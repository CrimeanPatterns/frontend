...
class TAccountCheckerAeromexicoSelenium extends TAccountChecker
{
    ...
    public function Login()
    {
        ...
        // Page hang
        if (
            $this->http->FindSingleNode('//form[@id="form-login"]//button[@id="btnSubmit" and @disabled="disabled"]')
            && $this->http->FindSingleNode('//form[@id="form-login"]//button[not(@id="btnSubmit") and @disabled="disabled"]')
        ) {

...
//                    $this->waitForElement(WebDriverBy::xpath('//button[data-testid="undefined-button"] | //a[href="#$userSignIn"]'), 5);
//                    $this->saveResponse();

                    $this->driver->executeScript('var btn = document.querySelector(\'button[data-testid="undefined-button"], a[href="#$userSignIn"]\'); if (btn) btn.click();');
    ...
    public function Login()
    {
        switch ($this->AccountFields['Login2']) {
            ...
            case 'us':
                ...
                $this->waitForElement(WebDriverBy::xpath($logoutItemXpath), 27, false);
                $this->saveResponse();

...
class RentalCar extends \TAccountChecker
{
    ...
    public static $dictionary = [
        "pt" => [
            ...
            'CONFIRA OS DADOS DA SUA RESERVA'    => ['CONFIRA OS DADOS DA SUA RESERVA', 'Confira abaixo informações importantes para a sua experiência com a Localiza', 'Tudo pronto para uma experiência completa', 'Informações detalhadas'],

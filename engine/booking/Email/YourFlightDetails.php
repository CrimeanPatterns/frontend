...
class YourFlightDetails extends \TAccountChecker
{
    ...
    public static $dictionary = [
        ...
        'pl' => [
            ...
            'Booking references'  => ['Numer rezerwacji:'],
            'Customer reference'  => 'Numer klienta',
            'stop'                => ['przesiadki', 'przesiadka'],
            'Your flight details' => ['Podsumowanie rezerwacji', 'Posumowanie lotu'],
            //'Your new flights'    => ['Your new flights'],
            'Direct'           => 'Bezpośredni',
            'durationRe'       => '(?: ?\d{1,2} ?(?:h|m))+', // 1h 00m    |    2h    |    55m
            'passenger'        => ['pasażerów'],
        ...
        'es' => [
            ...
            'stop'                => 'escala',
            'Your flight details' => ['Datos de tu vuelo', 'Vuelo a', 'Resumen de la reserva', 'Vuelo de ida', 'Resumen de tu vuelo'],
            // 'Your new flights' => [''],
            'Direct'              => 'Directo',
        ...
        'nl' => [
            ...
            'Customer reference'  => 'Referentie klant',
            'stop'                => 'tussenstop',
            'Your flight details' => ['Heenvlucht', 'Terugvlucht', 'Boekingsoverzicht'],
            // 'Your new flights' => [''],
            'Direct'              => 'Direkte',
            ...
            'to' => 'naar',
            //'Seats' => '',
            'Total price for' => 'Totaalprijs voor',
            // 'Copyright©' => '',
        ],
        'pt' => [
            'Hi'                  => 'Olá,',
            ...
            'stop'                => 'parada',
            'Your flight details' => ['Voo para', 'Resumo da reserva', 'O resumo do seu voo', 'Dados do seu voo', 'Voo de partida'],
            // 'Your new flights' => [''],
            'Direct'              => 'Direto',
            'durationRe'          => '(?: ?\d{1,2} (?:h|m))+', // 3 h 05 min
            'passenger'           => ['viajantes'],
            'E-ticket numbers'    => ["Número do e-ticket"],
            'From'                => 'De',
            'to'                  => 'para',
            'Seats'               => 'Assentos',
    ...
    private function twoSegmentsInOne(\DOMNodeList $segments, $key, \DOMNode $root, Flight $f, \PlancakeEmailParser $parser, string $segmentText)
    {
        ...
        $pattern1 = sprintf($format, '(?:\b[-[:alpha:]]+[,.\s]*)?(?:\b[Dd]\.\s*)?\d{1,2}(?:[.\s]*| de )[[:alpha:]]+\.?'); // 22. nov  |  ons 1 jan  |  søn. d. 27. apr | qui., 15 de mai.

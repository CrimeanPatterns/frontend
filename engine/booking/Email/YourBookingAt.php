...
class YourBookingAt extends \TAccountChecker
{
    ...
    public static $dictionary = [
        ...
        'lv' => [
            'Hi '              => ['Sveiki,'],
            'Your booking at'  => 'Jūsu rezervējums naktsmītnē',
            'confNumber'       => ['Apstiprinājuma numurs:'],
            'checkIn'          => ['Reģistrēšanās'],
            'Check-out'        => 'Izrakstīšanās',
            'or call them at:' => 'vai zvanot pa tālruni',
        ],
    ];
    ...
    private $detectors = [
        ...
        'es' => ['Tu reserva en '],
        'lv' => ['Jūsu rezervējums naktsmītnē '],
    ];
    ...
    private $detectSubject = [
        ...
        'lv' => [
            ['Pastāstiet naktsmītnes', 'pārstāvjiem, kad Jūs ieradīsieties'],
        ],
    ];

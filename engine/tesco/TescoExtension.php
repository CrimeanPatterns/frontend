...
class TescoExtension extends AbstractParser implements LoginWithIdInterface, ParseInterface
{
    ...
    public function login(Tab $tab, Credentials $credentials): LoginResult
    {
        ...
        $errorLogin = $tab->evaluate('//h5[contains(@class, "ddsweb-heading")]', EvaluateOptions::new()->allowNull(true));
        ...
        //h5[contains(@class, "ddsweb-heading")]');
    ...
    public function parse(Tab $tab, Master $master, AccountOptions $accountOptions): void
    {
        ...
        try {
            ...
            $balanceElement = $tab->evaluate("//span[contains(@class, 'balanceValue')]", EvaluateOptions::new()->allowNull(true));

            if (!$balanceElement) {
                $tab->saveHtml();
                $tab->saveScreenshot();
                $balanceElement = $tab->evaluate("//span[contains(@class, 'balanceValue')]", EvaluateOptions::new()->timeout('65')->allowNull(true));
            }

...
{
    public $mailFiles = "cheaptickets/it-818475439.eml, cheaptickets/it-818905639.eml, cheaptickets/it-821518859.eml, cheaptickets/it-821642329.eml, cheaptickets/it-895042920.eml";
    public $lang = 'en';
    ...
    public $detectLang = [
        ...
        "fr" => ["Numéro de réservation", "Numéro de vol :"],
    ];
    ...
    public static $dictionary = [
        ...
        "fr" => [
            ...
            "The E-ticket number is valid for all flights" => "Le numéro de billet électronique est valide pour tous les vols",
            "Departure"                                    => "Départ",
            "Arrival"                                      => "Arrivée",
            "Online check-in number"                       => "Numéro d’enregistrement en ligne",
            "Flight time:"                                 => "Durée du vol :",
            "Flight number:"                               => "Numéro de vol :",
            "Class:"                                       => "Classe :",
            "E-ticket number:"                             => "Numéro de billet électronique : ",
            "E-ticket"                                     => "Billet électronique de votre réservation",
            'Questions? We’re here to help!'               => 'Vous avez des questions ? Nous sommes là pour vous aider !',
    ...
    public static $providers = [
        ...
        'budgetair' => [
            ...
            'body' => ['BudgetAir_logo_S', 'BudgetAir_com_au_logo', 'BudgetAir_co_uk_Logo_S', 'BudgetAir_fr_Logo_S'],
        ],
    ...
    public function ParseFlightPDF(Email $email, $text): void
    {
        ...
        if (count($f->getTravellers()) > 1) {
            $flightText = $this->re("/^([ ]*{$this->opt($this->t('Departure'))}\b[ ]*.+)\n\n\n\n.+{$f->getTravellers()[1][0]}/msu", $text);
        } else {
        ...
        $flightParts = $this->splitText($flightText, "/^([ ]*{$this->t('Departure')}\b[ ]*.*)/m", true);

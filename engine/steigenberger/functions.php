    ...
    private function parseCancellationPolicy($cancellationDataAll, $h)
    {
        ...
        if ($equals === true) {
            if (
                ...
                || strstr($cancellationData['cancellation_policy_description'], 'Kostenfrei stornierbar bis 18:00 Uhr lokale Zeit am Tag der Anreise. Spätere Stornierung und Nicht-Anreise wird mit 90% des Gesamtaufenthaltes in Rechnung gestellt.')
            ) {
            ...
            if (strstr($cancellationData['cancellation_policy_description'], 'Kostenfrei stornierbar bis 5 Tage vor dem Anreisetag. Spätere Stornierung und Nicht-Anreise wird mit 90% des Gesamtaufenthaltes in Rechnung gestellt.')) {
                $h->parseDeadlineRelative("5 days", "00:00");

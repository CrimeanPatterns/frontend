...
class TAccountCheckerBevmo extends TAccountChecker
{
    ...
    public function ProcessStep($step)
    {
        ...
        if (strstr($this->http->currentUrl(), "Invalid+otp+code")) {
            $this->AskQuestion($this->Question, 'Invalid otp code', 'Question');
    ...
    private function processQuestion()
    {
        ...
        $this->AskQuestion("To keep your account secure we need to make sure it's really you before you can login.", null, 'Question');

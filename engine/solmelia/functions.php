...
//        $data = '{"operationName":"getToken","variables":{"user":"' . $this->AccountFields['Login'] . '","password":"' . str_replace('"', '\"', $this->AccountFields['Pass']) . '","lang":"en","countryNavigation":"US","rememberMe":true},"query":"query getToken($user: String!, $password: String!, $lang: String!, $countryNavigation: String!, $rememberMe: Boolean) {\n  getUserAccessToken(\n    origin: MELIA_COM\n    userType: CLIENT\n    lang: $lang\n    countryNavigation: $countryNavigation\n    auth: {username: $user, password: $password, rememberMe: $rememberMe}\n  ) {\n    accessToken\n    refreshToken\n    secondsToExpireAccessToken\n    secondsToExpireRefreshToken\n  }\n}\n"}';
        $data = '{"operationName":"getToken","variables":{"user":"' . $this->AccountFields['Login'] . '","password":"' . str_replace('"', '\"', $this->AccountFields['Pass']) . '","lang":"en","countryNavigation":"RU","rememberMe":true},"query":"query getToken($user: String!, $password: String!, $lang: String!, $countryNavigation: String!, $rememberMe: Boolean) {\n  getUserAccessToken(\n    origin: MELIA_COM\n    userType: CLIENT\n    lang: $lang\n    countryNavigation: $countryNavigation\n    auth: {username: $user, password: $password, rememberMe: $rememberMe}\n  ) {\n    accessToken\n    refreshToken\n    secondsToExpireAccessToken\n    secondsToExpireRefreshToken\n  }\n}"}';
        $headers = [
            "Accept"         => "*/*",
    ...
    */
    ...
    private function selenium()
    {
        ...
        try {
            ...
            $password = $selenium->waitForElement(WebDriverBy::xpath('//input[@id="password"]'), $WAIT_TIMEOUT);
            $this->savePageToLogs($selenium);
    ...
    private function getRecordedRequests($selenium)
    {
        ...
        } catch (AwardWallet\Common\Selenium\BrowserCommunicatorException | WebDriverCurlException $e) {

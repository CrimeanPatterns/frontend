...
class PaybackgermanExtension extends AbstractParser implements LoginWithIdInterface, ParseInterface
{
    ...
    public function login(Tab $tab, Credentials $credentials): LoginResult
    {
        ...
        // Password
        $loginShadowRoot = $tab->querySelector("pbc-login", QuerySelectorOptions::new()->timeout(120))->shadowRoot();
        ...
        | //div[contains(@class,"closable__title")]
        ...
        if (
            str_contains($errorOrSuccess->getInnerText(), 'Ungültige Eingabe')
            || str_contains($errorOrSuccess->getInnerText(), 'sind ungültig')
        ) {

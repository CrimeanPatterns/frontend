...
//        throw  new \AccountException();
    ...
    private function ParseRentalNew($providerHost, $arFields = [])
    {
        ...
        $pickUp = $this->http->FindSingleNode("//*[contains(.,'Reservation details')]/following-sibling::div/section//*[starts-with(normalize-space(),'Pick-up')]/../following-sibling::ul/li[1]");
        $pickUpTime = $this->http->FindSingleNode("//*[contains(.,'Reservation details')]/following-sibling::div/section//*[starts-with(normalize-space(),'Pick-up')]/../following-sibling::ul/li[2]");

        $dropOff = $this->http->FindSingleNode("//*[contains(.,'Reservation details')]/following-sibling::div/section//*[starts-with(normalize-space(),'Drop-off')]/../following-sibling::ul/li[1]");
        $dropOffTime = $this->http->FindSingleNode("//*[contains(.,'Reservation details')]/following-sibling::div/section//*[starts-with(normalize-space(),'Drop-off')]/../following-sibling::ul/li[2]");
...
//        throw  new \AccountException();
        ...
        if (!empty($otaConf) && stripos($otaConf, '***') === false) {
        ...
        if (empty($checkIn)) {
            $checkIn = $this->http->FindSingleNode("//div[contains(.,'Stay in')]//*[starts-with(normalize-space(),'Check') and contains(normalize-space(),'in')][1]/../following-sibling::ul/li[1]");
            $checkInTime = $this->http->FindSingleNode("//div[contains(.,'Stay in')]//*[starts-with(normalize-space(),'Check') and contains(normalize-space(),'in')][1]/../following-sibling::ul/li[2]");
        }

        if (empty($checkOut)) {
            $checkOut = $this->http->FindSingleNode("//div[contains(.,'Stay in')]//*[starts-with(normalize-space(),'Check') and contains(normalize-space(),'out')][1]/../following-sibling::ul/li[1]");
            $checkOutTime = $this->http->FindSingleNode("//div[contains(.,'Stay in')]//*[starts-with(normalize-space(),'Check') and contains(normalize-space(),'out')][1]/../following-sibling::ul/li[2]");
        }

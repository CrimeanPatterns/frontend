...
{
    public $rePlain = [
        ['#Thank\s+you\s+for\s+choosing\s+Expedia\.co|Thank you for booking your trip with AARP Travel Center powered by Expedia|This e-mail contains a copy of an AARP Travel Center powered by Expedia|Expedia itinerary number|Cet e-mail contient une copie d\'un voyage Expedia.be|This e-mail contains a copy of an Expedia.co.uk#i', 'blank', '/1'],
    ];
    public $reHtml = "";
    public $rePDF = "";
    public $reSubject = [
            ...
            "#.*?#" => [
                ...
                "#Duration|Départ#" => [
                    ...
                    "Passengers" => function ($text = '', $node = null, $it = null) {
                        $passengers = orval(
                            nodes("//tr[not(.//tr) and .//td[2 and (contains(., 'Adult') or contains(., 'Child') or contains(., 'Senior'))]]/ancestor-or-self::tr[1]/td[1]"),

...
class BookingConfirmation extends \TAccountChecker
{
    ...
    public $reSubject = [
        ...
        "no" => ["Bestillingsbekreftelse", 'Bokningsbekräftelse'],
        ...
        "ro" => ["Confirmarea rezervarii pentru"],
    ...
    public $reBody2 = [
        ...
        'tr' => ['Kiralama Bilgileri', 'REZERVASYON DETAYLARI'], //Kiralama Voucher'ı yerine geçer. Kiralama esnasında yanınızda bulundurulmalıdır.
        "sv" => ["Bokningsbekräftelse"],
        "ro" => ["DETALIILE REZERVARII"],
    ...
    public static $dictionary = [
        ...
        "no" => [
            "Your AVIS booking Confirmation:" => ["Bestillingsbekreftelse", "Ditt reservasjonssnummer er:", 'Bestillingsbekreftelse:'],
            "PICK UP DATE"                    => "HENTEDATO",
            "PICK UP LOCATION"                => ["HENTE LOKASJON", 'HENTESTED'],
            "RETURN DATE"                     => "RETURDATO",
            "RETURN LOCATION"                 => ["RETUR LOKASJON", 'LEVERINGSSTED'],
            // "Show location details" => "Informations de l'agence",
            "TELEPHONE NO"          => ["TELEFON NR", "TELEFONNUMMER"],
        ...
        "tr" => [
            "Your AVIS booking Confirmation:" => ["Rezervasyon Numarası", "AVIS Rezervasyon Onayınız:"],
            "PICK UP DATE"                    => ["Teslim Alma Tarihi", "ALIŞ TARİHİ"],
            "PICK UP LOCATION"                => "ALIŞ OFİSİ",
            "RETURN DATE"                     => ["İade Tarihi", 'DÖNÜŞ TARİHİ'],
            "RETURN LOCATION"                 => "DÖNÜŞ OFİSİ",
            "TELEPHONE NO"                    => ["Tel :", 'ÇALIŞMA SAATLERİ'],
            "OPENING HOURS"                   => "ÇALIŞMA SAATLERİ",
            "PRICE OF VEHICLE"                => ["Toplam ücret", 'ARAÇ FİYATI'],
            'Dear'                            => 'Sayın',
            "Your booking details:"           => "Rezervasyon Detaylarınız:",
            'or'                              => 'ör:',
            "Adress"                          => "Adres :",
        ...
        "ro" => [
            "Your AVIS booking Confirmation:" => "Confirmarea Rezervarii Avis:",
            "PICK UP DATE"                    => "DATA PRELUARII",
            "PICK UP LOCATION"                => "BIROU DE INCHIRIERE",
            "RETURN DATE"                     => "DATA RETURNARII",
            "RETURN LOCATION"                 => "BIROU DE RETURNARE",
            //            "Show location details"           => "",
            "TELEPHONE NO"                    => "NR. TELEFON",
            "OPENING HOURS"                   => "PROGRAM DE LUCRU",
            "Your booking details:"           => "Detaliile rezervarii:",
            "PRICE OF VEHICLE"                => "PRETUL MASINII",
            'Dear'                            => 'Draga',
            // 'Bestätigung folgt'               => 'Bestätigung folgt',
            // cancelled
            //            "Cancellation of your booking (number" => '',
        ...
        "et" => [
            "Your AVIS booking Confirmation:" => "Teie broneeringu number:",
            "PICK UP DATE"                    => "AUTO VÕTMISE AEG",
            "PICK UP LOCATION"                => "AUTO VÕTMISE KONTOR",
            "RETURN DATE"                     => "TAGASTUSAEG",
            "RETURN LOCATION"                 => "TAGASTUS KONTOR",
            //            "Show location details"           => "",
            "TELEPHONE NO"                    => "TELEFON",
            "OPENING HOURS"                   => "TEENINDUSAJAD",
            "Your booking details:"           => "Teie broneeringu üksikasjad:",
            "PRICE OF VEHICLE"                => "SÕIDUKI HIND",
            'Dear'                            => 'Lugupeetud',
            // 'Bestätigung folgt'               => 'Bestätigung folgt',
            // cancelled
            //            "Cancellation of your booking (number" => '',
    ...
    public function parseHtmlType2(Email $email): void
    {
        ...
        // PickupPhone
        $pickupPhone = $this->http->FindSingleNode('(//text()[' . $this->eq($this->t('TELEPHONE NO')) . ']/following::text()[1])[1]');
        ...
        // DropoffPhone
        $dropoffPhone = $this->http->FindSingleNode('(//text()[' . $this->eq($this->t('TELEPHONE NO')) . ']/following::text()[1])[2]');

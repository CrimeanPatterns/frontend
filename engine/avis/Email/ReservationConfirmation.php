...
class ReservationConfirmation extends \TAccountChecker
{
    ...
    private $subjects = [
        ...
        'es' => ['Confirmación de reservación:'],
    ];
    ...
    private static $dictionary = [
        ...
        'es' => [
            'Thank you'                      => 'Gracias',
            'CONFIRMATION NUMBER'            => 'SU NÚMERO DE CONFIRMACIÓN',
            'PICK UP'                        => 'RETIRO',
            'DROP OFF'                       => 'DEVOLUCIÓN',
            'YOUR CAR'                       => 'SU VEHÍCULO',
            'similar'                        => 'similar',
            'ESTIMATED TOTAL'                => 'TOTAL ESTIMADO',
            'PICK UP LOCATION'               => 'OFICINA DE RETIRO',
            'DROP OFF LOCATION'              => 'OFICINA DE DEVOLUCIÓN',
            'at'                             => ['at'],
            'reservation has been cancelled' => 'su reservación se anuló',
        ],
        'en' => [
    ...
    private function parseEmail(Email $email): void
    {
        ...
        if (preg_match($re, $datetimePickup, $matches)) {
            ...
            $matches['time'] = preg_replace("/^\s*(\d{1,2})(\d{2})\s*$/", '$1:$2', $matches['time']);
            $r->pickup()

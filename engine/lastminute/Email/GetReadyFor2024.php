...
{
    public $mailFiles = "lastminute/it-777328116.eml, lastminute/it-793321804-es.eml, lastminute/it-797149774.eml, lastminute/it-812678538-fr.eml, lastminute/it-833044196-da.eml, lastminute/it-852775817.eml, lastminute/it-859515263.eml, lastminute/it-867174984.eml, lastminute/it-902379506.eml";
    ...
    private function flight(Email $email): void
    {
        ...
        $xpath = "//tr[*[2][normalize-space() = '●']][following-sibling::tr]"
            . " | //tr[*[2][normalize-space() = '○']][following-sibling::tr][not(.//@style[{$this->contains(['border-right-style: dashed', 'border-right-style:dashed'])}])]";

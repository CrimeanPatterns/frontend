...
//            $selenium->http->setUserAgent($this->http->userAgent);
            ...
            $button = $selenium->waitForElement(WebDriverBy::xpath("//button[@id='sign-in']"), 0);
            ...
            $selenium->driver->executeScript("try { document.getElementById('stay-signedin').checked = true; } catch(e) {}");
            $this->saveToLogs($selenium);
            ...
            ');
            $button->click();
            //$selenium->driver->executeScript("document.getElementById('sign-in').click()");
            sleep(4);

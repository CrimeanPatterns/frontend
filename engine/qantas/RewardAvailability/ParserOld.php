...
class ParserOld extends \TAccountCheckerQantas
{
    use \PriceTools;
...
//        if ($this->attempt !== 2) {
//            $request->browserVersionMin = \HttpBrowser::BROWSER_VERSION_MIN - 2;
...
//            $script = '
//                fetch("https://book.qantas.com/qf-booking/dyn/air/booking/flexPricerCalendarActionFromLoad", {
//                    "credentials": "include",
//                    "headers": {
//                        "Accept": "application/json",
//                        "Accept-Encoding": "gzip, deflate, br, zstd",
//                        "Content-Type": "application/x-www-form-urlencoded",
//                    },
//                    "referrer": "https://book.qantas.com/qf-booking/dyn/air/booking/FFCO?SITE=QFQFQFBI&LANGUAGE=GB&TAB_ID=' . $this->tabId . '",
//                    "body": "' . $payload . '",
//                    "method": "POST",
//                    "mode": "cors"
//                }).then( response => {
...
//            }
//
//            $dataCalendar = $this->waitForElement(\WebDriverBy::xpath('//script[@id="dataCalendar"]'), 20, false);
//            $this->saveResponse();
//
//            if (!$dataCalendar) {
//                $errorURL = $this->http->currentUrl();
...
//            }
//
//            $resString = $this->http->FindSingleNode('//script[@id="dataCalendar"]/@datacalendar');
//            $resString = htmlspecialchars_decode($resString);
...
//                    }
                    ...
                    $DATES = urlencode(implode(',', array_map(function ($s) {
                        return date("dmYHi", $s['departure']['dateTime']) . 'ParserOld.php/' . date("dmYHi",
                                $s['arrival']['dateTime']);
                    }, $segments)));

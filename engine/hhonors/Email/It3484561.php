...
class It3484561 extends \TAccountChecker
{
    ...
    private static $dict = [
        ...
        'ru' => [
            ...
            'Guests:'               => 'Гости:',
            'Rooms:'                => 'Номера:',
            'Your Room Information' => 'Информация о номере',
            'Your Rate Information' => 'Информация о тарифе',
            // 'Rate Per Night'        => 'Cena za noc',
            //            'Honors Reward' => '',
            'Total for Stay'               => 'Всего за пребывание',
            // 'Total for Stay Per Room Rate' => 'Razem za pobyt w pokoju',
            //            'Taxes' => '',
            //            'see you on' => '',
            'Adult'                              => 'для взрослых',
            'Rate Rules and Cancellation Policy' => 'Правила тарифа и политика отмены',
            'Guest Name:'                        => 'Имя гостя:',
            'Room Plan:'                         => 'План комнаты:',
            //            'Child' => '',
            'View Booking Details' => 'Просмотреть сведения о бронировании', // @alt for img with dates
            'Maps & Directions'    => 'Карты и маршруты',
        ],
    ];

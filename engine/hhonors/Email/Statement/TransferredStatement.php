...
class TransferredStatement extends \TAccountChecker
{
    ...
    private $reSubject = [
        ...
        'Hilton Honors Points Purchase Confirmation',
    ];

    private static $dictionary = [
        'en' => [
            'Recipient Name' => ['Recipient Name', 'Points Deposited to', 'Points Transferred To', 'Name'],
        ],
    ];
    ...
    private function detectRecipient(): bool
    {
        $phrases = [
            ...
            'just sent you',
            'balance have been updated to reflect your Points purchase',
        ];
    ...
    private function detectTransfer(): bool
    {
        $phrases = [
            ...
            'Thank you for your recent request to transfer Hilton Honors Points',
        ];

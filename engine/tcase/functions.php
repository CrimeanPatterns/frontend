...
class TAccountCheckerTcase extends TAccountCheckerExtended
{
    ...
    {
        throw new CheckException("As of April 1, 2025, the TripCase app has sunset, and registered users will no longer be able to access or use the TripCase app. ", ACCOUNT_PROVIDER_ERROR);

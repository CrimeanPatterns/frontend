...
class Booking extends \TAccountChecker
{
    ...
    public static $dictionary = [
        ...
        "en" => [
            'adult'                     => ['adult', 'Adult'],
            'Departure Point'           => ['Meeting Point', 'Departure Point'],
            'View details'              => ['View details', 'Get your ticket'],
        ],
    ];
    ...
    private function ParseEmail(Email $email): void
    {
        ...
        if (stripos($url, 'linkprotect.cudasvc.com') !== false && preg_match("/(www\.viator\.com.+)&.+[=].+typo/", $url, $m)) {
            ...
            $url = str_replace(['%2f', '%3f', '%3d', '%252'], ['/', '?', '=', '%2'], $m[1]);
        }

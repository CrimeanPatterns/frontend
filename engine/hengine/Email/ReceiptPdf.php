...
{
    public $mailFiles = "hengine/it-886120240.eml, hengine/it-886398368.eml, hengine/it-892604306.eml";
    ...
    private function parseEmailPdf(Email $email, ?string $textPdf = null)
    {
        ...
        foreach ($hotelsText as $htext) {
            ...
            foreach ($roomsRows as $row) {
                ...
                $travellers = array_filter(array_map('trim', preg_replace("/\s+/", ' ', preg_split('/\n\s*\n/', $traveller))));

...
class YourTicketsTo extends \TAccountChecker
{
    ...
    public static $dictionary = [
        ...
        'fr' => [
            ...
            'Seat'          => ['Place'],
            'TRAIN'         => ['TRAIN'],
            'TICKET NUMBER' => ['Ticket n°', 'BILLET N°'],
        ...
        'nl' => [
            ...
            'Seat'          => ['Zitplaats'],
            'TRAIN'         => ['TREIN', 'TRAIN'],
            'TICKET NUMBER' => ['TICKETNR', 'Ticketnr'],
            'confNumber'    => ['Boekingsreferentie:'],
            'Coach'         => 'Rijtuig',
            'Please arrive' => ['Arriveer aub voor', 'Zorg ervoor', 'Afspraak aub om'],
        ],
    ];
    ...
    private $detectSubject = [
        ...
        // fr
        'Vos tickets Eurostar pour ',
        // nl
        'Je Eurostar-tickets naar',
    ];
    private $detectBody = [
        'en' => [
        ...
        'nl' => [
            'Graag tot binnenkort aan boord van onze treinen',
        ],
    ];
        ...
        foreach ($nodes as $root) {
            ...
            if (preg_match($re2, $node, $m)) {
                ...
                if (!empty($pax)) {
                    ...
                    if (isset($m['ticket']) && !in_array($m['ticket'], $tickets)) {

...
//            }
    ...
    private function parseItinerary($detail): void
    {
        ...
        $data = $detail->data->bookingBySession ?? null;
        ...
        try {
            ...
            try {
                $res = $selenium->waitForElement(WebDriverBy::xpath('
                    ...
                    | //div[@data-testid="snackbar-error-message" and normalize-space(.) != ""]
                    | //div[@role="alert"]//p
                '), 10);

                $resText = isset($res) ? $res->getText() : null;
            ...
            } elseif ($resText == 'Please reset your password') {
            ...
            } elseif (!empty($resText)) {
                $this->DebugInfo = $resText;
            }

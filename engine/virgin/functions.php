            ...
            */
            ...
            $this->setMitmProxy(
                (new Port())
                    ...
                    ->banUrls('quantummetric\.com|trackjs\.com|bing\.com')
//                    ->forceCacheUrls(Port::regexpFromExtensions(['css', 'js']))
            );
            */
...
//        }
    ...
    {
//        $this->http->GetURL('https://www.virginatlantic.com/myflyingclub/dashboard');
//
...
//
//        $this->selectLanguage($this);
//
//        $loginBtn = $this->waitForElement(WebDriverBy::xpath('//button[contains(@class, "login-btn") or contains(@class, "loginButton")] | //button[@aria-label="Flying Club"]'), 0);
//
//        if ($loginBtn) {
//            $loginBtn->click();
//
//            if ($myAcc = $this->waitForElement(WebDriverBy::xpath('//a[contains(., "My account")]'), 2)) {
...
//                && ($loginBtn = $this->waitForElement(WebDriverBy::xpath('//button[contains(@class, "login-btn") or contains(@class, "loginButton")]'), 0))
//            ) {
//                $loginBtn->click();
//                $this->waitForElement(WebDriverBy::xpath('
//                        //input[@id = "userId" or @id = "signInName"]
...
//        $this->closePopup($this);
//
//        $login = $this->waitForElement(WebDriverBy::xpath('//input[@id = "userId" or @id = "signInName"]'), 0);
//        $pass = $this->waitForElement(WebDriverBy::xpath('//input[@id = "password"]'), 0);
//
//        if (!$pass) {
//            $this->driver->executeScript('try { document.getElementById("password").style.zIndex = 9999; } catch(e) {}');
//            $pass = $this->waitForElement(WebDriverBy::xpath('//input[@id = "password"]'), 0);
//        }
//
//        if (!$login || !$pass) {

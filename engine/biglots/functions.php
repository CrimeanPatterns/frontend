...
//        $this->sendStaticSensorData();
    ...
    private function parseReCaptcha($key = '6LewU34UAAAAAHvXqFOcQlm8z1MP1xpGAZCYEeZY')
    {
...
//            "proxy"   => $this->getCaptchaProxy(),
    ...
    public function checkErrors()
    {
        ...
        if ($message = $this->http->FindSingleNode("//p[contains(text(), 'BigLots.com is currently unavailable, but will be back shortly. Please check back soon!')] | (//p[contains(text(), 'Check back soon for more stores')])[1]")) {

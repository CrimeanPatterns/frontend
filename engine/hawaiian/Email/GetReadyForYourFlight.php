...
{
    public $mailFiles = "hawaiian/it-259332214.eml, hawaiian/it-264109125.eml, hawaiian/it-264151106.eml, hawaiian/it-917619763.eml";
    ...
    private function parseHtml(Email $email): void
    {
        ...
        $travellers = $this->http->FindNodes("//*[{$this->eq($this->t("Traveler"))}]/following-sibling::*[normalize-space()][1]/descendant::text()[normalize-space()][1]");
        ...
        foreach ($nodes as $i => $root) {
            ...
            $info = implode("\n", $this->http->FindNodes("//text()[{$this->starts($this->t("Operated by Flight"))} or {$this->starts($this->t("Flight"))} ]{$pXpath}"));

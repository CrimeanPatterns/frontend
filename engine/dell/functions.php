...
class TAccountCheckerDell extends TAccountChecker
{
    ...
    public function InitBrowser()
    {
        ...
        if ($this->AccountFields['Login2'] == 'de') {
            $this->rewardsPageURL = "https://www.dell.com/myaccount/de-de/rewards";
        } else {
    ...
    public function LoadLoginForm()
    {
        ...
        $btn = $this->waitForElement(WebDriverBy::id('btnContinue'), 0);
        ...
        $pass = $this->waitForElement(WebDriverBy::id('userPwd_UserInputSecret'), 10);

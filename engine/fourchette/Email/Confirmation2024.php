...
{
    public $mailFiles = "fourchette/it-682591926.eml, fourchette/it-682820582.eml, fourchette/it-682905576.eml, fourchette/it-683032644.eml, fourchette/it-683566005.eml, fourchette/it-685326542.eml, fourchette/it-921545428.eml, fourchette/it-924641670.eml, fourchette/it-924955395.eml";
    ...
    private $detectBody = [
        'en' => [
            ...
            'Finalize your reservation at',
            'Booking recorded',
            'One last step! Complete your booking',
            'One last step! Complete your reservation'
        ],
        'it' => [
            ...
            'Ultimo passaggio! Completa la prenotazione',
        ],
        'pt' => [
            'Reserva registada',
            'Mais um passo',
        ...
        'es' => [
            ...
            'Reserva cancelada',
            'Reserva registrada',
            'Gracias por reservar en nuestro restaurante',
        ],
        'fr' => [
            'Réservation annulée',
            ...
            "Plus qu'une étape ! Finalisez votre réservation.",
        ],
        'nl' => [
        ...
        'sv' => [
            ...
            'du gjorde en bokning',
            'ack för att du bokat',
        ],
    ];
    ...
    private static $dictionary = [
        'en' => [
            'Dear '                           => ['Dear ', 'Hi ', 'Bonjour ', 'Dear Madam, Dear Sir', 'Dear Mr.', 'Buenos días,', 'Dear Sir, Dear Madam,', 'Dear Mrs.', 'Ciao', 'Hola,', 'Hey'],
        ...
        'es' => [
            'Dear ' => ['Buenos días,', 'Benvolgut/da,', 'Estimado/a', 'Hola,', 'Benvolgut/da, Bienvenida/o,'],
            // 'Reservation on the waiting list' => '',
        ...
        'fr' => [
            'Dear ' => ['Bonjour ', 'Bonjour M.', 'Chèr(e)', 'Buenos días,'],
            // 'Reservation on the waiting list' => '',
        ...
        'de' => [
            'Dear ' => ['Hallo ', 'Sehr geehrte(r) Frau/Herr ', 'Sehr geehrte/r Herr'],
            // 'Reservation on the waiting list' => '',
            // 'CancelledReservation' => ['Reservering geannuleerd', 'Je reservering bij ons restaurant is geannuleerd'],
            // 'PendingReservation' => ['', ''],
        ...
        'sv' => [
            ...
            ', you have booked a table at'                     => [', du gjorde en bokning denfre'],
    ...
    private function parseEmailHtml(Email $email): void
    {
        ...
        if (empty($traveller)) {
            $traveller = $this->http->FindSingleNode("//text()[{$this->contains($this->t(', you have booked a table at'))}]/preceding::text()[normalize-space()][1]", null, true, "/^(\w+)$/");
        }
        ...
        if ($name === null && $address === null){
            $placeXpath = "//text()[{$this->eq($this->t('Date'))}]/preceding::text()[normalize-space()][2]/ancestor::tr[1][count(.//text()[normalize-space()]) = 3]";

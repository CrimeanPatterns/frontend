...
{
    public $mailFiles = "fourchette/it-105599618.eml, fourchette/it-105904006.eml, fourchette/it-105995107.eml, fourchette/it-106685558.eml, fourchette/it-106685835.eml, fourchette/it-106685846.eml, fourchette/it-106802628.eml, fourchette/it-122481301.eml, fourchette/it-134165716-es.eml, fourchette/it-145463308.eml, fourchette/it-917420553.eml";
    ...
    private static $dictionary = [
        ...
        'es' => [ // it-134165716-es.eml
            ...
            'Réservation confirmée' => ['Reserva confirmada', 'Reserva cancelada', 'Reserva pendiente de confirmación'],
            'cancelled text'        => ['Reserva cancelada', 'Acabas de cancelar tu reserva'],
            'not confirmed text' => ['En cuanto verifiquemos la disponibilidad de mesa en el restaurante'],
            'Reserva pendente de confirmação' => ['Reserva pendiente de confirmación'],
            'personnes'               => ['persona', 'personas'],
        ...
        'de' => [
            'Bonjour '              => ['Hallo '],
            // ', qui vous rapporte'   => '',
            'Réservation confirmée' => ['Reservierung bestätigt', 'Reservierung storniert'],
            'cancelled text' => ['Deine Reservierung wurde storniert.'],
            // 'not confirmed text'              => ['a sua reserva ainda não está confirmada porque o restaurante'],

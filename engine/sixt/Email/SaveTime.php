...
class SaveTime extends \TAccountChecker
{
    ...
    public $reBody = [
        ...
        'pt' => [
            ...
            'Em breve, o seu carro alugado estará pronto',
        ],
        'es' => [
    ...
    public $reSubject = [
        ...
        "/Em breve - todas as informações necessárias para sua próxima reserva \d+/u",
        //nl
    ...
    public static $dict = [
        ...
        'pt' => [
            'Pickup Location'                    => ['Levantamento', 'Retirada'],
            'Return'                             => ['Devolução', 'Retorno'],
            'RESERVATION NUMBER:'                => ['NÚMERO DE RESERVA', 'Número de reserva'],
            'Dear '                              => ['Caro(a)', 'Olá,', 'Prezado(a)'],
            'Vehicle group'                      => ['Categoria do veículo', 'Seu grupo de carro selecionado'],
            'Taxes'                              => 'Le tasse',
            'Vehicle Subtotal'                   => 'Totale parziale veicolo',
    ...
    private function parseEmail(Email $email)
    {
        ...
        if (empty($confirmation)) {
            $confirmation = $this->re("/\s+(?:Invoice|Rechnung|reservation|fattura Sixt|sua próxima reserva)\s*(\d{9,})\b/u", $this->subject);
        }

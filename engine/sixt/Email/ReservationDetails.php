...
{
    public $mailFiles = "sixt/it-282880041.eml, sixt/it-337840682.eml, sixt/it-413867489.eml, sixt/it-428652947.eml, sixt/it-430974260.eml, sixt/it-530325692.eml, sixt/it-687894976.eml, sixt/it-898408071.eml";
    public $subjects = [
        // en
        ...
        '/Ihre Buchung bei .+ ist bestätigt: #/',
        // es
        ...
        '/Votre réservation.*a été mise à jour\./',
        '/Votre réservation chez .* est confirmée : #\d+/u',
        // pl
        '/Twoja rezerwacja.*została potwierdzona./',
        '/Twoja rezerwacja w .+ jest potwierdzona: #/',
        // it
        '/La tua .+ prenotazione \d+ è confermata/',
        '/La tua prenotazione .+ \d+ è stata aggiornata/',
        // pt
        '/Sua reserva foi atualizada/',
        '/Sua reserva em .+ está confirmada: #/',
        // nl
        '/Uw reservering bij .* is bevestigd: #\d+/',
        // zh
        '/您在 .* 的预订已确认：#\d+/u',
    ];
    ...
    public static $dictionary = [
        "en" => [
            ...
            'Estimated total (taxes incl.)' => ['Estimated total (taxes incl.)', 'Paid total (taxes incl.)',
                'Total due (taxes included)', 'Total paid (taxes included)', 'Total (taxes included)',
                'Total paid in advance', 'Estimated total at pickup', 'Total payment at pickup', 'Total at pickup', 'Total', 'Estimated total',
            ],
            // 'Pickup at' => '',
            // 'Return at' => '',
            'Get directions' => ['Get directions', 'See map'],
        ],
        "de" => [
            ...
            'Pickup at'                     => ['Abholung:'],
            'Return at'                     => ['Rückgabe:'],
            'Get directions'                => 'Karte anzeigen',
        ],
        "es" => [
            'Reservation number'            => ['Número de reserva', 'Reserva'],
            'Hello,'                        => ['Hola:', 'Gran elección,', 'Hola,'],
            'statusPhrases'                 => ['TU RESERVA ESTÁ', 'SU RESERVA HA SIDO'],
            'statusVariants'                => ['CONFIRMADA', 'ACTUALIZADA'],
            'Reservation details'           => ['Detalles de la reserva', 'TU RESERVA ESTÁ CONFIRMADA', 'SU RESERVA HA SIDO'],
            'Pick-up'                       => 'Recogida',
            //'Opening hours:'                => 'Öffnungszeiten:',
            //'Location info'                 => 'Infos zur Station',
            'Return'                        => 'Devolución',
            'Vehicle category'              => ['El modelo que solicitaste', 'Categoría de vehículo'],
            'Estimated total (taxes incl.)' => ['Total adeudado (impuestos incluidos)',
                'Total en la recogida', 'Pago total al recoger', ],
            'Pickup at' => 'Recogida en',
            'Return at' => 'Devolución en',
            // 'Get directions' => '',
        ],
        "fr" => [
            'Reservation number'            => ['Numéro de réservation', 'Réservation'],
            'Hello,'                        => ['Bonjour,', 'Excellent choix,'],
            'statusPhrases'                 => ['VOTRE RÉSERVATION A ÉTÉ', 'est', 'VOTRE RÉSERVATION EST'],
            'statusVariants'                => ['confirmée', 'MISE À JOUR', 'CONFIRMÉE'],
            ...
            'Estimated total (taxes incl.)' => ['Total payé (taxes incluses)', 'Total dû (taxes incluses)', 'Total (taxes comprises)', 'Paiement total à la collecte', 'Total',
                'Total payé d\'avance', 'Total à l\'enlèvement', ],
            'Pickup at'                     => ['Retrait à', 'Retrait at'],
            'Return at'                     => 'Retour à',
            // 'Get directions' => '',
        ],
        "pl" => [
            'Reservation number'            => ['Numer rezerwacji', 'Rezerwacja'],
            'Hello,'                        => ['Cześć,', 'Świetny wybór,'],
            'statusPhrases'                 => ['została', 'Twoja rezerwacja jest'],
            'statusVariants'                => ['potwierdzona', 'potwierdzona'],
            'Reservation details'           => ['Szczegóły rezerwacji', 'Twoja rezerwacja jest'],
            'Pick-up'                       => 'Odbiór',
            //'Opening hours:'                => 'Öffnungszeiten:',
            //'Location info'                 => 'Infos zur Station',
            'Return'                        => 'Zwrot',
            'Vehicle category'              => 'Kategoria pojazdu',
            'Estimated total (taxes incl.)' => ['Należność razem (z podatkiem)', 'Razem przy odbiorze',
                'Całość płatna z góry', ],
            'Pickup at'                     => 'Odbiór w',
            'Return at'                     => 'Powrót o',
            // 'Get directions' => '',
        ],
        ...
        "pt" => [
            ...
            'Hello,'                        => ['Olá,', 'Ótima escolha,'],
            'statusPhrases'                 => ['SUA RESERVA FOI'],
            'statusVariants'                => ['ATUALIZADA', 'CONFIRMADA'],
            'Reservation details'           => ['SUA RESERVA FOI', 'SUA RESERVA ESTÁ'],
            // 'Pick-up'                       => 'Ritiro',
            //'Opening hours:'                => 'Öffnungszeiten:',
            //'Location info'                 => 'Infos zur Station',
            // 'Return'                        => ['Restituzione', 'Riconsegna'],
            'Vehicle category'              => 'Categoria do veículo',
            'Estimated total (taxes incl.)' => ['Pagamento total na retirada', 'Total a pagar no levantamento',
                'Total pago antecipadamente', 'Total', ],
            'Pickup at'      => 'Recolha em',
            'Return at'      => 'Devolução em',
            'Get directions' => ['Obter direções', 'Ver mapa'],
        ],
        "nl" => [
            'Reservation number'            => 'Reservering',
            'Hello,'                        => 'Goede keuze,',
            'statusPhrases'                 => ['UW RESERVERING IS'],
            'statusVariants'                => ['BEVESTIGD'],
            'Reservation details'           => ['UW RESERVERING IS'],
            // 'Pick-up'                       => 'Ritiro',
            //'Opening hours:'                => 'Öffnungszeiten:',
            //'Location info'                 => 'Infos zur Station',
            // 'Return'                        => ['Restituzione', 'Riconsegna'],
            'Vehicle category'              => 'Voertuigcategorie',
            'Estimated total (taxes incl.)' => ['Totaal vooruitbetaald', 'Totaal',
                'Totaal bij ophalen',
            ],
            'Pickup at'                     => ['Afhalen bij', 'Ophalen bij'],
            'Return at'                     => 'Retourneren bij',
            'Get directions'                => 'Routebeschrijving',
        ],
        "zh" => [
            'Reservation number'            => '预订：',
            'Hello,'                        => '不错的选择',
            // 'statusPhrases' => ['UW RESERVERING IS'],
            // 'statusVariants' => ['BEVESTIGD'],
            'Reservation details'           => ['您的预订已确认'],
            // 'Pick-up'                       => 'Ritiro',
            //'Opening hours:'                => 'Öffnungszeiten:',
            //'Location info'                 => 'Infos zur Station',
            // 'Return'                        => ['Restituzione', 'Riconsegna'],
            'Vehicle category'              => '车型组',
            'Estimated total (taxes incl.)' => ['取车时总计', '预付总额'],
            'Pickup at'                     => '取车地点',
            'Return at'                     => '还车地点',
            'Get directions'                => '获取路线',
        ],
    ...
    public function ParseCar(Email $email): void
    {
        ...
        if (count($travellerNames) === 0) {
            $travellerNames = array_filter($this->http->FindNodes("//text()[{$this->starts($this->t('Hello,'))}]/ancestor::td[1]", null,
        ...
        $r->car()
            ...
            ->model($this->http->FindSingleNode("//text()[{$this->eq($this->t('Vehicle category'))}]/following::text()[normalize-space()][1][not({$this->contains($this->t('Your reservation details'))})]"), true, true);

        $patterns['dateTime'] = "/^(?<date>.{3,}?)\s*(?:at|um|à|\||às|om|在|Na|a las|)\s*(?<time>{$patterns['time']})\s*$/u";
    ...
    private function normalizeDate(?string $text): ?string
    {
        ...
        if (preg_match('/\b(\d{1,2})[,.\s]+([[:alpha:]]+)[,.\s]+(\d{4})$/u', $text, $m)) {
            ...
            $day = $m[2];
            $year = $m[3];
        } elseif (preg_match('/^\s*(\d{4})\s+(\d{1,2})月\s*(\d{1,2})\s*[[:alpha:]]+$/u', $text, $m)) {
            // 2025 4月 23 星期三
            $year = $m[1];
            $month = $m[2];
            $day = $m[3];
        }
        // $this->logger->debug('$text = '.print_r( $day . '/' . $month . ($year ? '/' . $year : ''),true));

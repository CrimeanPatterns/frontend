...
class BalanceFromTravelDeals extends \TAccountChecker
{
    ...
    public static $dictionary = [
        "en" => [
            'DetectFormat' => [
                ...
                'Medallion Qualification Dollars to reach Diamond Medallion Status',
            ],
        ],
    ];
    ...
    public function detectEmailByBody(PlancakeEmailParser $parser)
    {
        ...
        $condition2 =
            ...
            || $this->http->XPath->query("//text()[contains(normalize-space(), 'More Options When Traveling With Delta')]")->length > 0
            || $this->http->XPath->query("//text()[contains(normalize-space(), 'Medallion Qualification Dollars to reach Diamond Medallion Status')]")->length > 0;

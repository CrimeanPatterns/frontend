...
class EStatement extends \TAccountChecker
{
    ...
    private $reBody = [
        'en' => [
            ...
            ['eStatement is here', 'Enrich Points expiring by end of'],
            ['statement is here', 'Enrich Points expiring by end of'],
        ],
    ];
    private static $dictionary = [
        'en' => [
            'Dear'    => ['Dear Mrs', 'Dear Mr', 'Dear Miss', 'Mr ', 'Ms ', 'Dr ', 'Dear Mr. ', 'Dear '],
            'Balance' => ['Balance', 'Enrich Points balance'],
        ],
    ];
    ...
    public function ParsePlanEmailExternal(PlancakeEmailParser $parser, Email $email)
    {
        ...
        $this->logger->debug($name . ', ' . $status . ', ' . $number . ', ' . $balance);

...
{
    public $mailFiles = "ctmoney/statements/it-84984452.eml, ctmoney/statements/it-85613180.eml, ctmoney/statements/it-85761320.eml, ctmoney/statements/it-898564067.eml";
    public $subjects = [
        // en
    ...
    public static $dictionary = [
        "en" => [
            'detectBody' => [
                ...
                'Your accounts are successfully linked.',
            ],
            'Hey' => ['Hey', 'Hello', 'Hi'],
        ],
        "fr" => [
    ...
    public function ParsePlanEmailExternal(PlancakeEmailParser $parser, Email $email)
    {
        ...
        $number = $this->http->FindSingleNode("(//text()[{$this->starts($this->t('Triangle Rewards'))}])[1]/ancestor::tr[1]", null, true, "/Triangle Rewards\W* account ending in\s*(\d{4})$/");

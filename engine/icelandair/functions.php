...
//            "X-Access-Token" => $access_token,
        ...
        $this->http->GetURL("https://www.icelandair.com/api/new/profile/", $headers, 20);
...
//            $this->State['access_token'] = $access_token;
            ...
            $this->http->GetURL("https://www.icelandair.com/api/new/profile/");
    ...
    public function Parse()
    {
        ...
        $this->http->GetURL("https://www.icelandair.com/api/new/profile/card-info/");
        $this->http->GetURL("https://profile.icelandair.com/api/profile/card-info");
        $response = $this->http->JsonLog(null, 3, true);
        $points = ArrayVal($response, 'points');
        // Balance - Frequent flyer points
        $this->SetBalance(ArrayVal($points, 'awardPoints'));
        ...
        // Card points
        $this->SetProperty("CardPoints", ArrayVal($points, 'yearlyPoints'));
        // Status
        switch (ArrayVal($response['activeCard'], 'cardType')) {
            case '00':
        ...
        $pointsToExpire = ArrayVal($points, 'pointsToExpire', []);

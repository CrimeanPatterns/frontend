...
class IcelandairExtension extends AbstractParser implements LoginWithIdInterface
{
    ...
    {
        return 'https://my-account.icelandair.com/?showHeader=true';
    }

    public function isLoggedIn(Tab $tab): bool
    {
        $this->logger->info($tab->getUrl());
        $el = $tab->evaluate('//div[contains(@class, "FrequentFlyerButton_button_content")] | //span[@data-cy="profilePageAvatar"] | //input[@name="username"]');
    ...
    {
        $tab->gotoUrl('https://www.icelandair.com/profile/');
    ...
    public function login(Tab $tab, Credentials $credentials): LoginResult
    {
        ...
        $submitResult = $tab->evaluate('//span[@data-cy="sagaInfoPointsID"] | //span[@id="input_password_error"]/.. | //span[@data-cy="profilePageAvatar"]', EvaluateOptions::new()->timeout(180));

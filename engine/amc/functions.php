...
//        $this->seleniumOptions->addHideSeleniumExtension = false;
    ...
    public function Login()
    {
        ...
        if ($message = $this->http->FindSingleNode('//span[contains(@class, "Form--error-message")]/text() | //div[@role="alert" and contains(@class, "ErrorMessageAlert")]/p/text() | //p[@role = "alert"]')) {
            ...
            if (
                strstr($message, "The information you entered doesn't match what we have on file. Please check the information you entered or create a new AMC Stubs Account.")
                || strstr($message, "Your authentication could not be validated.")
            ) {

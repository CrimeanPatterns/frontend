...
{
    public $mailFiles = "reserveam/it-592674389.eml, reserveam/it-601814972.eml, reserveam/it-606149420-cancelled.eml, reserveam/it-630202812-recreation.eml, reserveam/it-630592843.eml, reserveam/it-867255744.eml, reserveam/it-887945862.eml";
    ...
    public static $dictionary = [
        'en' => [
            'confNumber'                => ['Your Reservation Number:', 'Your Reservation Number :'],
    ...
    private function assignLang(): bool
    {
        foreach ($this->detectBody as $lang => $detectBody) {
            if ($this->http->XPath->query("//*[{$this->contains($detectBody)}]")->length > 0
                ...
                && !empty(self::$dictionary[$lang]['checkIn']) && !empty(self::$dictionary[$lang]['Site Type:'])
                ...
                && $this->http->XPath->query("//text()[{$this->eq(self::$dictionary[$lang]['Site Type:'])}]")->length > 0
            ) {
                $this->lang = $lang;

...
class FlightChange extends \TAccountChecker
{
    ...
    public static $dictionary = [
        'en' => [
            'Booking reference'          => ["Booking reference", "Booking reference (PNR)", 'Booking Reference (PNR)'],
            'Booking reference (PNR)'    => ["Booking reference (PNR)", "Booking Reference (PNR)"],
    ...
    private $subjects = [
        'en' => [
            ...
            ' Important: Changes to your Qatar Airways flight schedule',
    ...
    private $detectBody = [
        'en' => [
            ...
            'We would like to inform you that there has been a change to the flight schedule',
        ],
    ];

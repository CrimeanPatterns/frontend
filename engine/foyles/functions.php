...
class TAccountCheckerFoyles extends TAccountChecker
{
    ...
    public function InitBrowser()
    {
        ...
        $this->setScreenResolution([2560, 1440]);
    }
...
//        $this->seleniumOptions->antiCaptchaProxyParams = $this->getCaptchaProxy();
    ...
    {
        $this->waitForElement(WebDriverBy::xpath('//div[@class = "loyalty-balance"]/span | //div[@id = "errorModal"] | //div[@id = "signin-tabpanel"]//div[@class = "migrate-password"] | //div[@class = "antigate_solver recaptcha error"] | //div[@id = "errorModal"]//div[contains(@class, "modal-body")]'), 30);

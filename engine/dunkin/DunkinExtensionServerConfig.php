...
class DunkinExtensionServerConfig extends AbstractServerConfig
{
    ...
    public function configureServerCheck(
        ...
        $seleniumOptions->setProxy($this->proxyManager->get(new NetNutRequest(NetNutRequest::COUNTRY_US)));
        return false;
    }
}

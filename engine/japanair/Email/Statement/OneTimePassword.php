...
{
    public $mailFiles = "japanair/statements/it-712231749.eml, japanair/statements/it-712536058.eml, japanair/statements/it-914820418.eml, japanair/statements/it-917638514.eml";
    ...
    public $detectSubject = [
        ...
        '[JAL] 일회용 비밀번호 알림',
        // id
        '[JAL] Notifikasi Kata Sandi Satu Kali',
    ];
    ...
    public static $dictionary = [
        ...
        'zh' => [
            'Please enter the above one-time password on the screen to verify your identity.'
                             => ['請在畫面上輸入上方的一次性密碼，以驗證您的身分。', '请输入界面上方的一次性密码验证您的身份'],
            'Japan Airlines' => '日本航空',
        ],
        'ko' => [
            'Please enter the above one-time password on the screen to verify your identity.'
        ...
        'id' => [
            'Please enter the above one-time password on the screen to verify your identity.'
                             => 'Masukkan kata sandi satu kali di atas pada layar untuk memverifikasi identitas Anda.',
            'Japan Airlines' => 'Japan Airlines',
        ],
    ];
    ...
    {
        if ($this->http->XPath->query("//*[{$this->contains(['Japan Airlines', '日本航空', '일본항공'])}]")->length === 0
        ) {
            return false;
        }

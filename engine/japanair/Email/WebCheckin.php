...
{
    public $mailFiles = "japanair/it-56631504.eml, japanair/it-57297601.eml, japanair/it-913907203.eml, japanair/it-917143372.eml";

    private $detectFrom = "@jal.com";

    private $detectSubject = [
        'Notice of  Web Check-in Result',
        'Notice of  Online Check in Result',
        '辦理網上登機手續通知',
        '웹 체크인 결과 안내',
        'オンラインチェックインに関するお知らせ',
    ];
    private $detectBodyHtml = [
        ...
        'en2' => 'Thank you for using Japan Airlines Online Check in Service',
        'zh' => '日本航空網上辦理登機服務',
        'kr' => '일본항공의 웹 체크인 서비스 을 이용해 주셔서 감사합니다',
        'ja' => 'JAL国際線オンラインチェックインサービスをご利用いただき、ありがとうございます。',
    ];
    ...
    private static $dictionary = [
        ...
        'kr' => [
            ...
            "Reference"             => "참조 번호",
            "Flight"                => "항공편",
            "Departure Information" => "출발 정보",
            "Arrival Information"   => "도착 정보",
        ],
        'ja' => [
            "Passenger Name"        => "ご搭乗者名",
            "Reference"             => "予約番号",
            "Flight"                => "ご搭乗便",
            "Departure Information" => "出発情報",

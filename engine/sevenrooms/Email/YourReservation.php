...
{
    public $mailFiles = "sevenrooms/it-119008128.eml, sevenrooms/it-119878114.eml, sevenrooms/it-173892316.eml, sevenrooms/it-206291742.eml, sevenrooms/it-365621411.eml, sevenrooms/it-446545074.eml, sevenrooms/it-49509598.eml, sevenrooms/it-50115295.eml, sevenrooms/it-50532943.eml, sevenrooms/it-68914514.eml, sevenrooms/it-716438063.eml, sevenrooms/it-904756251.eml, sevenrooms/it-909854665.eml, sevenrooms/it-910999487.eml, sevenrooms/it-911104710.eml, sevenrooms/it-911137958.eml, sevenrooms/it-913973409.eml, sevenrooms/it-915434136.eml, sevenrooms/it-915977583.eml, sevenrooms/it-917287213.eml, sevenrooms/it-919752723.eml";
    public static $dictionary = [
        'da' => [
            'Contact'                    => ['Kontakt'],
            'btnText'                    => ['administrer reservation'],
            'btn2Text'                   => ['afbestil reservation'],
            'add to calendar'            => ['tilføj til kalender'],
            //'cancelledPhrases'           => [''],
            //'statusPhrases'              => [''],
            //'statusVariants'             => [''],
            'Your reservation number is' => ['Dit reservationsnummer er'],
            'mailed by'                  => ['drevet af'],
            // 'imgLink' => '',
            //'startName' => [''],
            ...
            'on'                    => 'den',
            'guest'                 => ['gæster'],
            'NameAfter_mailedby_RE' => "Du modtager denne e-mail fra (.+) gennem SevenRooms",
        ],
        'de' => [
            'Contact'                    => ['Kontakt'],
            'btnText'                    => ['Reservierung verwalten', 'RESERVIERUNG BESTÄTIGEN'],
            'btn2Text'                   => ['Reservierung stornieren'],
            'add to calendar'            => ['zum Kalender hinzufügen'],
            //'cancelledPhrases'           => [''],
            //'statusPhrases'              => [''],
            //'statusVariants'             => [''],
            'Your reservation number is' => ['Ihre Reservierungsnummer lautet'],
            'mailed by'                  => ['angetrieben von'],
            // 'imgLink' => '',
            //'startName' => [''],
            'You are receiving this email from' => 'Du erhälst diese email von',
            'through'                           => 'über',
            'Your Reservation at'               => ['Ihre Reservierung im'],
            'for'                               => 'im',
            'on'                                => 'am',
            'guest'                             => ['Gäste'],
            'NameAfter_mailedby_RE'             => "Sie erhalten diese E-Mail von (.+) über SevenRooms",
        ],
        'es' => [
            'Contact'                    => ['Contacto'],
            'btnText'                    => ['gestionar reserva', 'CONFIRMAR RESERVA'],
            'btn2Text'                   => ['cancelar la reserva'],
            'add to calendar'            => ['añadir al calendario'],
            'cancelledPhrases'           => ['Esta reserva ha sido cancelada'],
            //'statusPhrases'              => [''],
            //'statusVariants'             => [''],
            'Your reservation number is' => ['Su número de reserva es'],
            'mailed by'                  => ['impulsado por correo', 'enviado por correo'],
            // 'imgLink' => '',
            //'startName' => [''],
            'You are receiving this email from' => 'Está recibiendo este correo electrónico de',
            'through'                           => 'a través de',
            'Your Reservation at'               => ['Su reserva en'],
            'for'                               => 'en',
            'on'                                => 'el',
            'guest'                             => ['comensales'],
            'NameAfter_mailedby_RE'             => 'Está recibiendo este correo electrónico de (.+) a través de SevenRooms',
        ],
        'pt' => [
            ...
            'cancelledPhrases'           => ['Esta reserva foi cancelada', 'Confirmamos o cancelamento da sua reserva'],
            //'statusPhrases'              => [''],
            //'statusVariants'             => [''],
            ...
            // 'imgLink' => '',
            //'startName' => [''],
            'You are receiving this email from' => 'Você está recebendo este email de',
            'through'                           => 'através de',
        ...
        'it' => [ // it-119008128.eml
            ...
            // 'imgLink' => '',
            // 'startName' => [''],
            'You are receiving this email from' => 'Hai ricevuto questa email da',
            'through'                           => 'tramite',
        ...
        'fr' => [ // it-119878114.eml
            'Contact'                    => 'Contact',
            'btnText'                    => ['Ajouter au calendrier', 'ajouter au calendrier', 'CONFIRMER LA RÉSERVATION', 'Confirmer votre réservation', 'Modifier votre réservation', 'AJOUTER UNE CARTE DE CRÉDIT'],
            ...
            'mailed by'                  => ['envoyé par', 'alimenté par', 'mailed by'],
            // 'imgLink' => '',
            //'startName' => [''],
        ...
        'en' => [
            ...
            'btnText'          => ['add to calendar', 'Click below to confirm your reservation', 'CONFIRM RESERVATION',
                'll be there after tomorrow!', 'BOOK OR DECLINE THIS RESERVATION', 'map', 'Check Availability & Book',
            ],
            ...
            'cancelledPhrases' => ['This reservation has been cancelled', 'This reservation has been canceled', 'cancel your reservation at',
                ...
                'has been cancelled', 'has been canceled', 'has been succesfully cancelled',
                'We regret to have received your wish to cancel your reservation',
                'Allo! Baba is very sorry that you cancelled because now she cannot see you soon.',
            ...
            'Cancellation Policy'   => ['Cancellation Policy', 'CANCELLATIONS/REFUNDS'],
            'total'                 => ['total', 'Total'],
        ],
    ];
    ...
    private $detectSubject = [
        ...
        "de" => ["Ihre Reservierung im",
            'Bitte bestätigen Sie Ihre Reservierung im',
            'Deine Reservierung bei', ],
        "es" => ["Su reserva en", "Confirme su reserva en"],
        "pt" => ["A sua reserva no",
            "a sua reserva no",
            'Cancelamento de reserva no restaurante', ],
    ...
    public function detectEmailByBody(\PlancakeEmailParser $parser)
    {
        ...
        if ($this->http->XPath->query('//text()[contains(.,"www.sevenrooms.com") or contains(.,"@sevenrooms.com") or contains(.,"SevenRooms")]')->length === 0
            ...
            && $this->http->XPath->query('//img[contains(@src,"www.sevenrooms.com") or contains(@href,".sevenrooms.com/")]')->length === 0
        ) {
            return false;
        }
    ...
    private function parseHtml(Email $email): void
    {
        $patterns = [
            ...
            'titleName'     => '(?:Dr|Miss|Mrs|Mr|Ms|Mme|Mr/Mrs|Mrs/Mr|Monsieur)\b\.?',
        ...
        $traveller = $this->http->FindSingleNode("//*[contains(@class,'client-name')]", null, true, "#^\s*(?:{$patterns['titleName']})?\s*({$patterns['travellerName']})\s*$#u")
            ?? $this->re("#\s[|]\s*(?:{$patterns['titleName']})?\s*({$patterns['travellerName']})\s+{$this->opt($this->t('on'))}\s#u", $this->Subject)
        ;
...
//            $this->logger->debug('$xpath 4 = '.print_r( $xpath,true));
        ...
        if (empty($mainText)) {
            $xpath = "//text()[{$this->eq($this->t('Contact'))}]/ancestor::div[count(./child::table) >= 3]/descendant::table[{$this->contains($this->t('guest'))}]/descendant::text()[normalize-space()][{$ruleChanged}]";
//            $this->logger->debug('$xpath 5 = '.print_r( $xpath,true));
            $mainText = implode("\n", $this->http->FindNodes($xpath));
        }

        if (empty($mainText) || preg_match("/^\s*{$this->opt($this->t('btnText'))}/", $mainText)) {
            $mainText = implode("\n", $this->http->FindNodes("(//text()[{$this->contains($this->t('btnText'))}])[1]/preceding::text()[normalize-space()][string-length() < 100]"));
        }
...
//        $this->logger->debug('$mainText = '.print_r( $mainText,true));
        ...
        if (preg_match("/(\&)/u", $traveller)) {
            $travellers[] = explode("&", $traveller);

            foreach ($travellers[0] as $tr) {
                $e->general()->traveller($tr);
            }
        } else {
            if ($traveller) {
        ...
        if (empty($name)) {
            $name = $this->http->FindSingleNode("//text()[{$this->starts($this->t('You are receiving this email from'))}]", null, true, "/^\s*{$this->opt($this->t('You are receiving this email from'))}\s*(.+?)\s*{$this->opt($this->t('through'))}/");
        }
        ...
        if (empty($name)) {
            $name = $this->http->FindSingleNode("//text()[{$this->contains($traveller)}]/preceding::img[1]/@alt");
        }
        ...
        if (empty($address)) {
            $address = $this->http->FindSingleNode("//text()[{$this->starts($this->t('You are receiving this email from'))}]/preceding::text()[normalize-space()][1][ preceding::*[1][{$this->contains('sevenrooms.com')} or {$this->contains('sevenrooms.com', '@src')} or {$this->contains('sevenrooms.com', '@href')}] ]");
        }
        ...
        $cancellation = implode(' ', $this->http->FindNodes("//div[ preceding::div[{$this->eq($this->t('Cancellation Policy'))}] and following::div[{$this->starts($this->t('Your reservation number is'))}] ]/descendant::text()[string-length(normalize-space())>2]"));

        if (empty($cancellation)) {
            $cancellation = implode(' ', $this->http->FindNodes("//text()[{$this->eq($this->t('Cancellation Policy'))}]/ancestor::*[count(descendant::text()[normalize-space()]) > 1][1]/descendant::text()[normalize-space()][not({$this->eq($this->t('Cancellation Policy'))})]"));
        }

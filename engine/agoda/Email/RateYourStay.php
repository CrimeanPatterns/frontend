...
class RateYourStay extends \TAccountChecker
{
    ...
    public static $dictionary = [
        'en' => [
            ", let's rate your stay!" => [", let's rate your stay!", ', Claim your VIP Gold!'],
        ...
        'pt' => [
            ", let's rate your stay!" => [', classifique a sua estadia!', ', obtenha o estatuto VIP Gold!'],
        ...
        'nl' => [
            ", let's rate your stay!" => ', beoordeel uw verblijf!',
            'Booking ID:'             => ['Boekingsnummer:'],
            'HotelNameStart'          => ['Beoordeel uw verblijf bij'],
            'HotelNameEnd'            => '.',
            '→'                       => '→',
        ],
        'id' => [
            ", let's rate your stay!" => ', nilai pengalaman menginap Anda!',
            'Booking ID:'             => ['ID Pesanan:'],
            'HotelNameStart'          => ['Berikan nilai untuk penginapan Anda di'],
            'HotelNameEnd'            => '.',
            '→'                       => '→',
        ],
    ];

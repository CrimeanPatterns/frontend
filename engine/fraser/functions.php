    ...
    public function Login()
    {
        ...
        if (!$this->http->PostForm()) {
            ...
            if (
                ...
                && $this->http->FindSingleNode('//h2[normalize-space() = "Don\'t worry it\'s us, not you. We are doing our best to fix the problem"] | //p[contains(text(), "We\'re experiencing technical difficulties and are unable to display the page you\'re looking for at this moment.")]')
            ) {
                $this->captchaReporting($this->recognizer);

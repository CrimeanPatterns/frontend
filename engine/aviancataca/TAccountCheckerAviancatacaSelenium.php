...
class TAccountCheckerAviancatacaSelenium extends TAccountChecker
{
    ...
    {
        $this->http->GetURL("https://www.lifemiles.com/account/elite/benefits");
        $this->waitForElement(WebDriverBy::xpath('//div[@class="account-ui-VipBenefits_entry"]/div[contains(text(), "entries")]'), 20);
        $this->saveResponse();

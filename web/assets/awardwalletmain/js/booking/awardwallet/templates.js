CKEDITOR.addTemplates('default',
    {
        imagesPath: CKEDITOR.getUrl('/assets/awardwalletmain/js/booking/awardwallet/images/'),
        ...
        templates:[
            ...
            //        '<p>Thanks <br />Team AwardWallet</p>'
            // },
            {
                title : 'Signature',
                image : 'pre-appt.png',
                description : '',
                html :
                    '<p>Best Regards, <br />James Anderson <br />AwardWallet Booking Team</p>'
            },
            {
                ...
                description : '',
                html :
                    '<p>We share your anticipation about finding a suitable low cost \'Saver\' award with the most efficient routing possible. While our award searches on your behalf are ongoing and exhaustive, ultimately we can only search and find what the airlines choose to to release.</p>' +
                    ...
                    '<p>There is no need for you to make ongoing inquiries about the status of your award request; we will alert you once there is a promising opportunity.</p>'+
                    '<p>Best regards, <br />AwardWallet Booking Team</p>'
            },
            {
                title : 'Schedule Call',
                image : 'pre-appt.png',
                description : '',
                html :
                    '<p>You can schedule a call by cllicking on an available time below:</p>' +
                    '<div>{{ awardwallet_schedule }}</div>'
            },
            {
                title : 'It may be easier to finalize this booking via phone',
                image : 'pre-appt.png',
                description : '',
                html :
                    '<p>Hi XXX</p>' +
                    '<p>It may be easier to finalize this booking via phone. If you are interested in that, please select the time that works best for you and we will give you a call at the time you requested:</p><br>' +
                    '<div>{{ awardwallet_schedule }}</div>'
            },
            {
               title: 'Chart',
               ...
               html:
                  ...
                  '<p>Thank you, <br />Team AwardWallet</p>'
            },
            // {
            //    title: 'Choose Option',
            //    image:  'pre-appt.png',
            ...
            //        '<p>We look forward to the challenge of earning your confidence and business. <br />The AwardWallet Crew</p>'
            // },
            // {
            ...
            //     '<p>Sincerely, <br />AwardWallet Team</p>'
            // },
            // {
            ...
            //        '<p>All the best, <br />Team AwardWallet</p>'
            // },
            // {
            ...
            // },
            {
                ...
                '<p>Look forward <br />Team AwardWallet</p>'
            },
            {
            ...
            },
            {
               ...
               html:
                   ...
                   '<p>Cheers, <br />Team AwardWallet</p>'
            },
            // {
            ...
            //     '<p>Thanks,<br />AwardWallet Team</p>'
            // },
            // {
            //     title: 'Africa',
            //     image: 'proposal_prep.png',
            ...
            
            {
                ...
                html:
                    ...
                    '<p>We have personally flown on Ethiopian, and as AwardWallet company owners, they will only recommend airlines to clients like you, that they are willing to book for their friends and family. The airline has invested in updated aircraft like the 787.</p>'+
            ...
            },
            {
                ...
                html:
                    ...
                    '</ul>'+
                    '<p>OUR PRINCIPALS REVIEWS</p>'+
                    '<p>We have personally flown on China Southern, and as AwardWallet company owners, they will only recommend airlines to clients like you, that they are willing to book for their friends and family. The airline has invested in updated aircraft like the 787.</p>'+
                    '<p>OUR CUSTOMERS UNANIMOUS REVIEWS</p>'+
            ...
            },
            {
                ...
                html:
                    ...
                    '</ul>'+
                    '<p>OUR PRINCIPALS REVIEWS</p>'+
                    '<p>We have personally flown on China Eastern, and as AwardWallet company owners, they will only recommend airlines to clients like you, that they are willing to book for their friends and family. The airline has invested in updated aircraft like the 787.</p>'+
                    '<p>OUR CUSTOMERS UNANIMOUS REVIEWS</p>'+
            ...
            },
            {
                ...
                html:
                    ...
                    '</ul>'+
                    '<p>OUR PRINCIPALS REVIEWS</p>'+
                    '<p>We have personally flown on EgyptAir, and as AwardWallet company owners, they will only recommend airlines to clients like you, that they are willing to book for their friends and family. The airline has invested in updated aircraft like the 787.</p>'+
                    '<p>OUR CUSTOMERS UNANIMOUS REVIEWS</p>'+
            ...
            },
            {
                ...
                html:
                    ...
                    '<p>Yet, instead of easily redeeming your hoped-for nonstop or streamlined 1 stop award routing directly with your airline program or credit company, you ended up on the door step of AwardWallet.</p>'+
            ...
            },
            {
                ...
                html:
                    ...
                    '<p>Thank you, <br />AwardWallet Team</p>'
            },
            {
                ...
                description: '',
                html:
                '<p>We personally fly and vet every airline that we recommend to folks like you. As well, we have booked hundreds of awards with this airline over the last three years with nary a negative feedback.</p>'+
            ...
            // },
            {
                ...
                '<p>More soon.</p><p>Cheers,<br />AwardWallet Team</p>'
            },
            // {
            //    title: 'POST APPT',
            //    image:  'after_appt.png',
            ...
            // },
            {
                ...
                '<p>Thanks,<br />The AwardWallet Team</p>'
            },
            // {
            ...
            },
            {
                ...
                description: '',
                html: '<p>Dear</p>' +
                '<p>While AwardWallet is known for our expertise in redeeming mileage awards (we recently crested over 3 BILLION miles), we also figured you might appreciate being privy to some of our mileage earning strategies.</p>'+
            ...
            },
            {
                ...
                html: '<p>Dear [Name],</p>'+
                      ...
                      '<p>Regards, <br />AwardWallet Team</p>'
            },
            {
                title: 'NO UPGRADES',
                image:  'admin.png',
            ...
            },
            {
                ...
                html: '<p>Our records indicate that we have not received payment for our services and the prepaid taxes for your itinerary.</p>'+
                      ...
                      '<p>Thank you for your prompt attention. <br />AwardWallet Team</p>'
            },
            {
                ...
                '<p><a style="text-decoration: none; font-weight: bold; color: #4684c4; word-break: break-all;" href="https://awardwallet.com/blog/link/ccbya">https://awardwallet.com/blog/link/ccbya</a></p>'+
                '<p>We look forward to the challenge of earning your future confidence and business..</p>'+
                '<p>Cheers <br />AwardWallet Team</p>'+
                '<p style="border-top: 1px solid #b3b3b3; padding-top: 5px"><strong>P.S.</strong> If a 7 day team travel competition featuring a mystery itinerary of Europe accomplishing surprise challenges (creativity and resourcefulness, not speed or fitness) in pursuit of up to $3000 cash prize sounds exciting, check out our other company <a style="text-decoration: none; font-weight: bold; color: #4684c4; word-break: break-all;" href="http://www.competitours.com">www.competitours.com</a>. Enjoy a trip packed with rivalry by day and revelry by night!</p>'
            },
            // {
            ...
            //           '<p>Look forward, <br />AwardWallet Team</p>'
            // },
            {
            ...
            //     '<p>$XXX airline taxes (prepaid by AwardWallet)</p>'+
            ...
            //     'Look forward,<br>AwardWallet Team<br>' +
            //     '{{ AwardWallet_schedule }}'
            // },
            {
            ...
            },
            {
                ...
                '<p>Much obliged, <br />AwardWallet</p>'
            },
            {
                title: 'SINGAPORE',
                image:  'special-instructions.png',
                ...
                '<p>Much obliged, <br />The AwardWallet Team</p>'
            },
            {
                title: 'KOREAN',
                image:  'special-instructions.png',
            ...
            },
            {
                ...
                '<p>Much obliged,<br />AwardWallet Team</p>'
            },
            {
                title: 'BA',
                image:  'special-instructions.png',
                ...
                '<p>Look forward<br>AwardWallet</p>'
            },
            // {
            ...
            //           '<p>Based on AwardWallet’s’ experience with similar award routing requests, we find that waiting 1-2 weeks in hopes of improved award options typically has the following results:</p>'+
            //           '<ul style="padding-left:0">'+
            ...
            //           '<p>Our service typically offers a far more seamless service, but the restrictions imposed by the companion cert require more customer involvement.</p>'+
            //           '<p>If you are amenable to the above, we will be poised to try and assist.</p>'+
            //           '<p>Look forward,<br />AwardWallete</p>'
            // },
            // {
            ...
            //     image: 'admin.png',
            //     description: '',
            //     html: '<p>Thank you for entrusting AwardWallet with your flight needs and we appreciated the opportunity to earn your confidence and business.</p>'+

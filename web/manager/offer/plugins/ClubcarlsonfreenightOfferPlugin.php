...
class ClubcarlsonfreenightOfferPlugin extends OfferPlugin
{
    public function getParams($offerUserId, $preview = false, $params = null)
    {
        ...
        $accountSql = $repAccount->getAccountsSQLByUser($userID, "AND (p.ProviderID = 383)");
    ...
    public function searchUsers()
    {
        ...
        $q = new TQuery("
                ...
                from Account a join Provider p on
                 a.ProviderID = p.ProviderID
                where p.Code = 'carlson'
            ");
        set_time_limit(59);

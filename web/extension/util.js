...
util.getSubAccountHistoryStartDate = function (account, subAccountCode) {
    if (!account.subAccountHistoryStartDate) return null;
    if (!account.subAccountHistoryStartDate[subAccountCode]) return null;

    return account.subAccountHistoryStartDate[subAccountCode]
};